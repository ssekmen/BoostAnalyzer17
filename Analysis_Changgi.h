...
Analysis::define_selections(const eventBuffer& d)
{
  ...
  //analysis_cuts['S'].push_back({ .name="2W",         .func = []    { return nTightWTag==2;                    }});
	//analysis_cuts['S'].push_back({ .name="MR_R2",      .func = [&d]  { return MR_new>=800 && R2_new>=0.08;  }});
  //analysis_cuts['S'].push_back({ .name="1W",         .func = []    { return nTightWTag==1;                    }});
	analysis_cuts['S'].push_back({ .name="MR_R2",      .func = [&d]  { return MR>=800 && R2>=0.08;  }});
  analysis_cuts['S'].push_back({ .name="1W",         .func = []    { return (nWDeep1==1 && nZDeep1==0) || (nWDeep1==0 && nZDeep1==1);   }});
	//analysis_cuts['S'].push_back({ .name="MR_R2",      .func = [&d]  { return MR_new>=800 && R2_new>=0.08;  }});
	if(isJetHT) analysis_cuts['S'].push_back({ .name="HLT",.func = [this,&d] { return isData ? d.HLT_PFHT1050==1  : 1; }});
	else if(isMET) analysis_cuts['S'].push_back({ .name="HLT",.func = [this,&d] { return isData ? !(d.HLT_PFHT1050==1 ) && (d.HLT_PFHT500_PFMET100_PFMHT100_IDTight==1 || d.HLT_PFHT500_PFMET110_PFMHT110_IDTight==1 || d.HLT_PFHT700_PFMET85_PFMHT85_IDTight==1 || d.HLT_PFHT700_PFMET95_PFMHT95_IDTight==1 || d.HLT_PFHT800_PFMET75_PFMHT75_IDTight==1 || d.HLT_PFHT800_PFMET85_PFMHT85_IDTight==1) : 1; }});
	else      analysis_cuts['S'].push_back({ .name="HLT",.func = [this,&d] { return isData ? d.HLT_PFHT1050==1  || (d.HLT_PFHT500_PFMET100_PFMHT100_IDTight==1 || d.HLT_PFHT500_PFMET110_PFMHT110_IDTight==1 || d.HLT_PFHT700_PFMET85_PFMHT85_IDTight==1 || d.HLT_PFHT700_PFMET95_PFMHT95_IDTight==1 || d.HLT_PFHT800_PFMET75_PFMHT75_IDTight==1 || d.HLT_PFHT800_PFMET85_PFMHT85_IDTight==1) : 1; }});
	...
	analysis_cuts['S'].push_back({ .name="0Mu",        .func = []    { return nMuVeto==0;                       }});
	analysis_cuts['S'].push_back({ .name="0Tau",       .func = []    { return nTauVeto==0;                      }});
	//analysis_cuts['S'].push_back({ .name="0b",         .func = []    { return nLooseBTag==0;                    }});
	analysis_cuts['S'].push_back({ .name="0b",         .func = []    { return nLooseBTag==0;                    }});
  //analysis_cuts['S'].push_back({ .name="1W",         .func = []    { return nTightWTag>=1;                    }});
	analysis_cuts['S'].push_back({ .name="mDPhi",      .func = []    { return dPhiRazor<2.8;                 }});
	...
	//analysis_cuts['A'].push_back({ .name="NJet",       .func = []    { return nJet>=3;                          }});
	analysis_cuts['A'].push_back({ .name="NJet",       .func = []    { return nJet>=2;                          }});
  //analysis_cuts['A'].push_back({ .name="2W",         .func = []    { return nTightWTag==2;                    }});
  analysis_cuts['A'].push_back({ .name="2W",         .func = []    { return nWDeep1==1 && nZDeep1==1;                    }});
	//analysis_cuts['A'].push_back({ .name="MR_R2",      .func = [&d]  { return MR_new>=800 && R2_new>=0.08;  }});
  //analysis_cuts['A'].push_back({ .name="1W",         .func = []    { return nTightWTag==1;                    }});
	analysis_cuts['A'].push_back({ .name="MR_R2",      .func = [&d]  { return MR>=800 && R2>=0.08;  }});
	if(isJetHT) analysis_cuts['A'].push_back({ .name="HLT",.func = [this,&d] { return isData ? d.HLT_PFHT1050==1  : 1; }});
	else if(isMET) analysis_cuts['A'].push_back({ .name="HLT",.func = [this,&d] { return isData ? !(d.HLT_PFHT1050==1 ) && (d.HLT_PFHT500_PFMET100_PFMHT100_IDTight==1 || d.HLT_PFHT500_PFMET110_PFMHT110_IDTight==1 || d.HLT_PFHT700_PFMET85_PFMHT85_IDTight==1 || d.HLT_PFHT700_PFMET95_PFMHT95_IDTight==1 || d.HLT_PFHT800_PFMET75_PFMHT75_IDTight==1 || d.HLT_PFHT800_PFMET85_PFMHT85_IDTight==1) : 1; }});
	else      analysis_cuts['A'].push_back({ .name="HLT",.func = [this,&d] { return isData ? d.HLT_PFHT1050==1  || (d.HLT_PFHT500_PFMET100_PFMHT100_IDTight==1 || d.HLT_PFHT500_PFMET110_PFMHT110_IDTight==1 || d.HLT_PFHT700_PFMET85_PFMHT85_IDTight==1 || d.HLT_PFHT700_PFMET95_PFMHT95_IDTight==1 || d.HLT_PFHT800_PFMET75_PFMHT75_IDTight==1 || d.HLT_PFHT800_PFMET85_PFMHT85_IDTight==1) : 1; }});
	...
	analysis_cuts['A'].push_back({ .name="0b",         .func = []    { return nLooseBTag==0;                    }});
	//analysis_cuts['A'].push_back({ .name="0b",         .func = []    { return nLooseBTag==0;                    }});
  //analysis_cuts['A'].push_back({ .name="1W",         .func = []    { return nTightWTag>=1;                    }});
  ...
  analysis_cuts['a'].push_back({ .name="2W",         .func = []    { return nWDeep1==1 && nZDeep1==1;                    }});
	//analysis_cuts['a'].push_back({ .name="MR_R2",      .func = [&d]  { return MR_new>=800 && R2_new>=0.08;  }});
  //analysis_cuts['a'].push_back({ .name="1W",         .func = []    { return nTightWTag==2;                    }});
	analysis_cuts['a'].push_back({ .name="MR_R2",      .func = [&d]  { return MR>=800 && R2>=0.08;  }});
	if(isJetHT) analysis_cuts['a'].push_back({ .name="HLT",.func = [this,&d] { return isData ? d.HLT_PFHT1050==1  : 1; }});
	else if(isMET) analysis_cuts['a'].push_back({ .name="HLT",.func = [this,&d] { return isData ? !(d.HLT_PFHT1050==1 ) && (d.HLT_PFHT500_PFMET100_PFMHT100_IDTight==1 || d.HLT_PFHT500_PFMET110_PFMHT110_IDTight==1 || d.HLT_PFHT700_PFMET85_PFMHT85_IDTight==1 || d.HLT_PFHT700_PFMET95_PFMHT95_IDTight==1 || d.HLT_PFHT800_PFMET75_PFMHT75_IDTight==1 || d.HLT_PFHT800_PFMET85_PFMHT85_IDTight==1) : 1; }});
	else      analysis_cuts['a'].push_back({ .name="HLT",.func = [this,&d] { return isData ? d.HLT_PFHT1050==1  || (d.HLT_PFHT500_PFMET100_PFMHT100_IDTight==1 || d.HLT_PFHT500_PFMET110_PFMHT110_IDTight==1 || d.HLT_PFHT700_PFMET85_PFMHT85_IDTight==1 || d.HLT_PFHT700_PFMET95_PFMHT95_IDTight==1 || d.HLT_PFHT800_PFMET75_PFMHT75_IDTight==1 || d.HLT_PFHT800_PFMET85_PFMHT85_IDTight==1) : 1; }});
  ...
  analysis_cuts['t'].push_back({ .name="1Top",       .func = []    { return nHadTopTag>=1;                    }}); 
	...
	analysis_cuts['V'].push_back({ .name="NJet",       .func = []    { return nJet>=2;                          }});
	analysis_cuts['V'].push_back({ .name="MR_R2",      .func = [&d]  { return MR>=800 && R2>=0.08;  }});
	if(isJetHT) analysis_cuts['V'].push_back({ .name="HLT",.func = [this,&d] { return isData ? d.HLT_PFHT1050==1  : 1; }});
	else if(isMET) analysis_cuts['V'].push_back({ .name="HLT",.func = [this,&d] { return isData ? !(d.HLT_PFHT1050==1 ) && (d.HLT_PFHT500_PFMET100_PFMHT100_IDTight==1 || d.HLT_PFHT500_PFMET110_PFMHT110_IDTight==1 || d.HLT_PFHT700_PFMET85_PFMHT85_IDTight==1 || d.HLT_PFHT700_PFMET95_PFMHT95_IDTight==1 || d.HLT_PFHT800_PFMET75_PFMHT75_IDTight==1 || d.HLT_PFHT800_PFMET85_PFMHT85_IDTight==1) : 1; }});
	else      analysis_cuts['V'].push_back({ .name="HLT",.func = [this,&d] { return isData ? d.HLT_PFHT1050==1  || (d.HLT_PFHT500_PFMET100_PFMHT100_IDTight==1 || d.HLT_PFHT500_PFMET110_PFMHT110_IDTight==1 || d.HLT_PFHT700_PFMET85_PFMHT85_IDTight==1 || d.HLT_PFHT700_PFMET95_PFMHT95_IDTight==1 || d.HLT_PFHT800_PFMET75_PFMHT75_IDTight==1 || d.HLT_PFHT800_PFMET85_PFMHT85_IDTight==1) : 1; }});
	analysis_cuts['V'].push_back({ .name="1Lep",       .func = []    { return nLepVeto>=2;                      }});
	analysis_cuts['V'].push_back({ .name="0b",         .func = []    { return nLooseBTag==0;                    }});
	analysis_cuts['V'].push_back({ .name="1mTop",       .func = []   { return nBoostMassTag>=2;                    }});
	...
	// Z: Z->ll enriched control sample
	analysis_cuts['Z'].push_back({ .name="1JetAK8",    .func = []    { return nJetAK8>=1;                      }}); 
	analysis_cuts['Z'].push_back({ .name="NJet",       .func = []    { return nJet>=2;                          }});
	analysis_cuts['Z'].push_back({ .name="MR_R2ll",    .func = [&d]  { return MR>=800 && R2_ll>=0.08;     }});
	if(isJetHT) analysis_cuts['Z'].push_back({ .name="HLT",.func = [this,&d] { return isData ? d.HLT_PFHT1050==1  : 1; }});
	else if(isMET) analysis_cuts['Z'].push_back({ .name="HLT",.func = [this,&d] { return isData ? !(d.HLT_PFHT1050==1 ) && (d.HLT_PFHT500_PFMET100_PFMHT100_IDTight==1 || d.HLT_PFHT500_PFMET110_PFMHT110_IDTight==1 || d.HLT_PFHT700_PFMET85_PFMHT85_IDTight==1 || d.HLT_PFHT700_PFMET95_PFMHT95_IDTight==1 || d.HLT_PFHT800_PFMET75_PFMHT75_IDTight==1 || d.HLT_PFHT800_PFMET85_PFMHT85_IDTight==1) : 1; }});
	else      analysis_cuts['Z'].push_back({ .name="HLT",.func = [this,&d] { return isData ? d.HLT_PFHT1050==1  || (d.HLT_PFHT500_PFMET100_PFMHT100_IDTight==1 || d.HLT_PFHT500_PFMET110_PFMHT110_IDTight==1 || d.HLT_PFHT700_PFMET85_PFMHT85_IDTight==1 || d.HLT_PFHT700_PFMET95_PFMHT95_IDTight==1 || d.HLT_PFHT800_PFMET75_PFMHT75_IDTight==1 || d.HLT_PFHT800_PFMET85_PFMHT85_IDTight==1) : 1; }});
...
*/
	...
	scale_factors['S'].push_back(sf_ele_veto);
	scale_factors['S'].push_back(sf_muon_veto);
	scale_factors['S'].push_back(sf_btag_loose);
	scale_factors['S'].push_back(sf_w);

	scale_factors['s'] = scale_factors['S'];
	scale_factors['t'] = scale_factors['S'];
	scale_factors['A'] = scale_factors['S'];
	scale_factors['a'] = scale_factors['S'];
	...
	scale_factors['V'].push_back(sf_btag_loose);
...
TH1D* h_R2_WZc0b_S;
TH2D* h_R2_MR_WZ0b_S;
TH2D* h_R2_MR_WZc0b_S;
TH1D* h_R2MR_WZ0b_S;
TH1D* h_R2MR_WZc0b_S;

TH1D* h_dPhiRazor_WZ0b_S;
TH1D* h_mDPhi_WZ0b_S;
TH2D* h_R2_MR_WZ0b_S_mDPhi;
TH1D* h_dPhiRazor_WZc0b_S;
TH1D* h_mDPhi_WZc0b_S;
TH2D* h_R2_MR_WZc0b_S_mDPhi;
...
TH1D* h_R2MR_Wjet_S_nj45;
TH2D* h_R2_MR_Wjet_S_nj6;
TH1D* h_R2MR_Wjet_S_nj6;
...
TH1D* h_nVDeep1_Q;
TH1D* h_nHDeep1_Q;
TH1D* h_nTopDeep1_Q_nj45;
TH1D* h_nVDeep1_Q_nj45;
TH1D* h_nHDeep1_Q_nj45;
TH1D* h_nTopDeep1_Q_nj6;
TH1D* h_nVDeep1_Q_nj6;
TH1D* h_nHDeep1_Q_nj6;

TH1D* h_nTopDeep1_T;
TH1D* h_nVDeep1_T;
TH1D* h_nHDeep1_T;
TH1D* h_nTopDeep1_T_nj45;
TH1D* h_nVDeep1_T_nj45;
TH1D* h_nHDeep1_T_nj45;
TH1D* h_nTopDeep1_T_nj6;
TH1D* h_nVDeep1_T_nj6;
TH1D* h_nHDeep1_T_nj6;

TH1D* h_nTopDeep1_W;
TH1D* h_nVDeep1_W;
TH1D* h_nHDeep1_W;
TH1D* h_nTopDeep1_W_nj45;
TH1D* h_nVDeep1_W_nj45;
TH1D* h_nHDeep1_W_nj45;
TH1D* h_nTopDeep1_W_nj6;
TH1D* h_nVDeep1_W_nj6;
TH1D* h_nHDeep1_W_nj6;
...
TH1D* h_Topjets_mass_Q;
TH1D* h_Topjets_mass_T;
TH1D* h_Topjets_mass_W;
TH1D* h_Topjets_mass_Q_nj45;
TH1D* h_Topjets_mass_T_nj45;
TH1D* h_Topjets_mass_W_nj45;
TH1D* h_Topjets_mass_Q_nj6;
TH1D* h_Topjets_mass_T_nj6;
TH1D* h_Topjets_mass_W_nj6;
#endif
...
Analysis::init_analysis_histos(const unsigned int& syst_nSyst, const unsigned int& syst_index)
{
  ...
  h_deepTag_TvsQCD_L = new TH1D("deepTag_TvsQCD_L", ";deepTag_{TvsQCD}", 20, 0, 1);
	...
	h_MR_WZ0b_S  = new TH1D("MR_WZ0b_S",  ";MR_{AK4}",nbn_MR,bn_MR);
	h_MR_WZc0b_S = new TH1D("MR_WZc0b_S", ";MR_{AK4}",nbn_MR,bn_MR);
	h_R2_WZ0b_S  = new TH1D("R2_WZ0b_S",  ";R2_{AK4}",nbn_R2,bn_R2);
	h_R2_WZc0b_S = new TH1D("R2_WZc0b_S", ";R2_{AK4}",nbn_R2,bn_R2);
	h_R2_MR_WZ0b_S = new TH2D("R2_MR_WZ0b_S", ";MR_{AK4};R2_{AK4}",nbn_MR,bn_MR,nbn_R2,bn_R2);
	h_R2_MR_WZc0b_S = new TH2D("R2_MR_WZc0b_S", ";MR_{AK4};R2_{AK4}",nbn_MR,bn_MR,nbn_R2,bn_R2);
	h_R2MR_WZ0b_S  = new TH1D("R2MR_WZ0b_S", ";MR_{WZ}XR2_{WZ}", 15,0,3000);
	h_R2MR_WZc0b_S = new TH1D("R2MR_WZc0b_S", ";MR_{WZ}XR2_{WZ}",15,0,3000);
	h_R2MR_Wjet_S = new TH1D("R2MR_Wjet_S", ";MR_{AK4}XR2_{AK4}",15,0,3000);
	h_R2MR_Wjet_S_nj45 = new TH1D("R2MR_Wjet_S_nj45", ";MR_{AK4}XR2_{AK4}",15,0,3000);
	h_R2MR_Wjet_S_nj6 = new TH1D("R2MR_Wjet_S_nj6", ";MR_{AK4}XR2_{AK4}",15,0,3000);
  h_dPhiRazor_WZ0b_S = new TH1D("dPhiRazor_WZ0b_S", ";#Delta#phi_{megajets}", 64,0,3.2);
  h_mDPhi_WZ0b_S = new TH1D("mDPhi_WZ0b_S", ";min#Delta#phi_{MET, Jet}", 64,0,3.2);
  h_R2_MR_WZ0b_S_mDPhi = new TH2D("R2_MR_WZ0b_S_mDPhi", ";MR_{AK4};R2_{AK4}",nbn_MR,bn_MR,nbn_R2,bn_R2);;
  h_dPhiRazor_WZc0b_S = new TH1D("dPhiRazor_WZc0b_S", ";#Delta#phi_{megajets}", 64,0,3.2);
  h_mDPhi_WZc0b_S = new TH1D("mDPhi_WZc0b_S", ";min#Delta#phi_{MET, Jet}", 64,0,3.2);
  h_R2_MR_WZc0b_S_mDPhi = new TH2D("R2_MR_WZc0b_S_mDPhi", ";MR_{AK4};R2_{AK4}",nbn_MR,bn_MR,nbn_R2,bn_R2);;
  ...
  h_nTopDeep1_Q = new TH1D("nTopDeep1_Q", "N_{Top}",10,0,10);
  h_nVDeep1_Q   = new TH1D("nVDeep1_Q", "N_{V}",10,0,10);
  h_nHDeep1_Q   = new TH1D("nHDeep1_Q", "N_{H}",10,0,10);
  h_nTopDeep1_Q_nj45 = new TH1D("nTopDeep1_Q_nj45", "N_{Top}",10,0,10);
  h_nVDeep1_Q_nj45   = new TH1D("nVDeep1_Q_nj45", "N_{V}",10,0,10);
  h_nHDeep1_Q_nj45   = new TH1D("nHDeep1_Q_nj45", "N_{H}",10,0,10);
  h_nTopDeep1_Q_nj6 = new TH1D("nTopDeep1_Q_nj6", "N_{Top}",10,0,10);
  h_nVDeep1_Q_nj6   = new TH1D("nVDeep1_Q_nj6", "N_{V}",10,0,10);
  h_nHDeep1_Q_nj6   = new TH1D("nHDeep1_Q_nj6", "N_{H}",10,0,10);

  h_nTopDeep1_T = new TH1D("nTopDeep1_T", "N_{Top}",10,0,10);
  h_nVDeep1_T   = new TH1D("nVDeep1_T", "N_{V}",10,0,10);
  h_nHDeep1_T   = new TH1D("nHDeep1_T", "N_{H}",10,0,10);
  h_nTopDeep1_T_nj45 = new TH1D("nTopDeep1_T_nj45", "N_{Top}",10,0,10);
  h_nVDeep1_T_nj45   = new TH1D("nVDeep1_T_nj45", "N_{V}",10,0,10);
  h_nHDeep1_T_nj45   = new TH1D("nHDeep1_T_nj45", "N_{H}",10,0,10);
  h_nTopDeep1_T_nj6 = new TH1D("nTopDeep1_T_nj6", "N_{Top}",10,0,10);
  h_nVDeep1_T_nj6   = new TH1D("nVDeep1_T_nj6", "N_{V}",10,0,10);
  h_nHDeep1_T_nj6   = new TH1D("nHDeep1_T_nj6", "N_{H}",10,0,10);

  h_nTopDeep1_W = new TH1D("nTopDeep1_W", "N_{Top}",10,0,10);
  h_nVDeep1_W   = new TH1D("nVDeep1_W", "N_{V}",10,0,10);
  h_nHDeep1_W   = new TH1D("nHDeep1_W", "N_{H}",10,0,10);
  h_nTopDeep1_W_nj45 = new TH1D("nTopDeep1_W_nj45", "N_{Top}",10,0,10);
  h_nVDeep1_W_nj45   = new TH1D("nVDeep1_W_nj45", "N_{V}",10,0,10);
  h_nHDeep1_W_nj45   = new TH1D("nHDeep1_W_nj45", "N_{H}",10,0,10);
  h_nTopDeep1_W_nj6 = new TH1D("nTopDeep1_W_nj6", "N_{Top}",10,0,10);
  h_nVDeep1_W_nj6   = new TH1D("nVDeep1_W_nj6", "N_{V}",10,0,10);
  h_nHDeep1_W_nj6   = new TH1D("nHDeep1_W_nj6", "N_{H}",10,0,10);

	h_R2MR_V  = new TH1D("R2MR_V",  ";MR_{AK4}XR2_{AK4}", 15,0,3000);
  h_mDPhi_V = new TH1D("mDPhi_V", ";#Delta#phi_{megajets}", 64,0,3.2);
  h_dRll_V  = new TH1D("dRll_V",  ";dR_{ll}", 40, 0, 2);
  h_Mll_V   = new TH1D("Mll_V",   ";Mass_{ll}", 34,30,200);
  h_pTll_V  = new TH1D("pTll_V",  ";p_{T, ll}",200,0,1000);
  h_nLep_V  = new TH1D("nLep_V",  ";N_{Lep}", 10,0,10);
	...
	h_Topjets_mass_Q = new TH1D("Topjets_mass_Q",";mass_{Boostjets}",100,0,500);
	h_Topjets_mass_Q_nj45 = new TH1D("Topjets_mass_Q_nj45",";mass_{Boostjets}",100,0,500);
	h_Topjets_mass_Q_nj6 = new TH1D("Topjets_mass_Q_nj6",";mass_{Boostjets}",100,0,500);
	h_Topjets_mass_T = new TH1D("Topjets_mass_T",";mass_{Boostjets}",100,0,500);
	h_Topjets_mass_T_nj45 = new TH1D("Topjets_mass_T_nj45",";mass_{Boostjets}",100,0,500);
	h_Topjets_mass_T_nj6 = new TH1D("Topjets_mass_T_nj6",";mass_{Boostjets}",100,0,500);
	h_Topjets_mass_W = new TH1D("Topjets_mass_W",";mass_{Boostjets}",100,0,500);
	h_Topjets_mass_W_nj45 = new TH1D("Topjets_mass_W_nj45",";mass_{Boostjets}",100,0,500);
	h_Topjets_mass_W_nj6 = new TH1D("Topjets_mass_W_nj6",";mass_{Boostjets}",100,0,500);
#endif
...
*/
		...
		*/
		...
		w = sf_weight['V'];
		if (apply_all_cuts('V')) {
      TLorentzVector vleps = veto_leptons[0]+veto_leptons[1];
      h_dRll_V->Fill(veto_leptons[0].DeltaR(veto_leptons[1]),w);
      //if(veto_leptons[0].DeltaR(veto_leptons[1]) > 0.4){
        h_nLep_V->Fill(nLepVeto,w);
			  h_R2MR_V->Fill(MR*R2, w);
			  h_mDPhi_V->Fill(dPhiRazor,w);
        h_Mll_V->Fill(vleps.M(),w);
        h_pTll_V->Fill(vleps.Pt(),w);
      //}
    }
		// W enriched region
		w = sf_weight['W'];
		if (apply_all_cuts('W')) {
      h_nTopDeep1_W->Fill(nTopDeep1,w);
      h_nVDeep1_W->Fill(nWDeep1+nZDeep1,w);
      h_nHDeep1_W->Fill(nHDeep1,w);
        ...
        h_deepTag_TvsQCD_W->Fill(data.FatJet[iBoostMassTag[i]].deepTag_TvsQCD, w);
			...
			for (size_t i=0; i<iBoostMassTag.size(); ++i) {
				...
				h_Topjets_mass_W->Fill(data.FatJet[iBoostMassTag[i]].msoftdrop, w);
        h_deepTagMD_WvsQCD_W->Fill(data.FatJet[iBoostMassTag[i]].deepTagMD_WvsQCD, w);
        h_deepTagMD_TvsQCD_W->Fill(data.FatJet[iBoostMassTag[i]].deepTagMD_TvsQCD, w);
        h_deepTag_WvsQCD_W->Fill(data.FatJet[iBoostMassTag[i]].deepTag_WvsQCD, w);
        h_deepTag_TvsQCD_W->Fill(data.FatJet[iBoostMassTag[i]].deepTag_TvsQCD, w);
      ...
      h_nTopDeep1_W_nj45->Fill(nTopDeep1,w);
      h_nVDeep1_W_nj45->Fill(nWDeep1+nZDeep1,w);
      h_nHDeep1_W_nj45->Fill(nHDeep1,w);
				...
				h_Topjets_mass_W_nj45->Fill(data.FatJet[iBoostMassTag[i]].msoftdrop, w);
				}
#endif
      ...
      h_nTopDeep1_W_nj6->Fill(nTopDeep1,w);
      h_nVDeep1_W_nj6->Fill(nWDeep1+nZDeep1,w);
      h_nHDeep1_W_nj6->Fill(nHDeep1,w);
				...
				h_Topjets_mass_W_nj6->Fill(data.FatJet[iBoostMassTag[i]].msoftdrop, w);
				}
#endif
			}
		}
...
*/
		...
		w = sf_weight['T'];
		if (apply_all_cuts('T')) {
      h_nTopDeep1_T->Fill(nTopDeep1,w);
      h_nVDeep1_T->Fill(nWDeep1+nZDeep1,w);
      h_nHDeep1_T->Fill(nHDeep1,w);
        ...
        h_deepTag_TvsQCD_T->Fill(data.FatJet[iBoostMassTag[i]].deepTag_TvsQCD, w);
			...
			for (size_t i=0; i<iBoostMassTag.size(); ++i) {
				...
				h_Topjets_mass_T->Fill(data.FatJet[iBoostMassTag[i]].msoftdrop, w);
        h_deepTagMD_WvsQCD_T->Fill(data.FatJet[iBoostMassTag[i]].deepTagMD_WvsQCD, w);
        h_deepTagMD_TvsQCD_T->Fill(data.FatJet[iBoostMassTag[i]].deepTagMD_TvsQCD, w);
        h_deepTag_WvsQCD_T->Fill(data.FatJet[iBoostMassTag[i]].deepTag_WvsQCD, w);
        h_deepTag_TvsQCD_T->Fill(data.FatJet[iBoostMassTag[i]].deepTag_TvsQCD, w);
      ...
      h_nTopDeep1_T_nj45->Fill(nTopDeep1,w);
      h_nVDeep1_T_nj45->Fill(nWDeep1+nZDeep1,w);
      h_nHDeep1_T_nj45->Fill(nHDeep1,w);
				...
				h_Topjets_mass_T_nj45->Fill(data.FatJet[iBoostMassTag[i]].msoftdrop, w);
				}
#endif
			}
			//if(nJet>=6){
      ...
      h_nTopDeep1_T_nj6->Fill(nTopDeep1,w);
      h_nVDeep1_T_nj6->Fill(nWDeep1+nZDeep1,w);
      h_nHDeep1_T_nj6->Fill(nHDeep1,w);
				...
				h_Topjets_mass_T_nj6->Fill(data.FatJet[iBoostMassTag[i]].msoftdrop, w);
				}
#endif
			}
		}
...
*/
      ...
      if(nBoostMassTag ==1) {
		...
		if (apply_all_cuts('Q')) {
			...
			h_njet_Q    ->Fill(nJet,        w);
			h_nAK8jet_Q ->Fill(nJetAK8,     w);
      h_nTopDeep1_Q->Fill(nTopDeep1,w);
      h_nVDeep1_Q->Fill(nWDeep1+nZDeep1,w);
      h_nHDeep1_Q->Fill(nHDeep1,w);
			h_ht_AK4_Q->Fill(AK4_Ht, w);
			h_MR_Q->Fill(MR, w);
			h_R2_Q->Fill(R2, w);
			h_MET_Q->Fill(data.MET_pt,w);
        ...
        h_deepTag_TvsQCD_Q->Fill(data.FatJet[iBoostMassTag[i]].deepTag_TvsQCD, w);
			...
			for (size_t i=0; i<iBoostMassTag.size(); ++i) {
				...
				h_Topjets_tau21_Q->Fill(tau21.at(iBoostMassTag[i]), w);
				h_Topjets_tau32_Q->Fill(tau32.at(iBoostMassTag[i]), w);
				h_Topjets_mass_Q->Fill(data.FatJet[iBoostMassTag[i]].msoftdrop, w);
        h_deepTagMD_WvsQCD_Q->Fill(data.FatJet[iBoostMassTag[i]].deepTagMD_WvsQCD, w);
        h_deepTagMD_TvsQCD_Q->Fill(data.FatJet[iBoostMassTag[i]].deepTagMD_TvsQCD, w);
        h_deepTag_WvsQCD_Q->Fill(data.FatJet[iBoostMassTag[i]].deepTag_WvsQCD, w);
        h_deepTag_TvsQCD_Q->Fill(data.FatJet[iBoostMassTag[i]].deepTag_TvsQCD, w);
      ...
      h_nTopDeep1_Q_nj45->Fill(nTopDeep1,w);
      h_nVDeep1_Q_nj45->Fill(nWDeep1+nZDeep1,w);
      h_nHDeep1_Q_nj45->Fill(nHDeep1,w);
				h_ht_AK4_Q_nj45->Fill(AK4_Ht, w);
				h_MR_Q_nj45->Fill(MR, w);
				h_R2_Q_nj45->Fill(R2, w);
				h_MET_Q_nj45->Fill(data.MET_pt,w);
				...
				for (size_t i=0; i<iBoostMassTag.size(); ++i) {
					...
					h_Topjets_tau21_Q_nj45->Fill(tau21.at(iBoostMassTag[i]), w);
					h_Topjets_tau32_Q_nj45->Fill(tau32.at(iBoostMassTag[i]), w);
				h_Topjets_mass_Q_nj45->Fill(data.FatJet[iBoostMassTag[i]].msoftdrop, w);
				}
#endif
			}
			//if(nJet>=6){
      ...
      h_nTopDeep1_Q_nj6->Fill(nTopDeep1,w);
      h_nVDeep1_Q_nj6->Fill(nWDeep1+nZDeep1,w);
      h_nHDeep1_Q_nj6->Fill(nHDeep1,w);
				h_ht_AK4_Q_nj6->Fill(AK4_Ht, w);
				h_MR_Q_nj6->Fill(MR, w);
				h_R2_Q_nj6->Fill(R2, w);
				h_MET_Q_nj6->Fill(data.MET_pt,w);
				...
				for (size_t i=0; i<iBoostMassTag.size(); ++i) {
					...
					h_Topjets_tau21_Q_nj6->Fill(tau21.at(iBoostMassTag[i]), w);
					h_Topjets_tau32_Q_nj6->Fill(tau32.at(iBoostMassTag[i]), w);
				h_Topjets_mass_Q_nj6->Fill(data.FatJet[iBoostMassTag[i]].msoftdrop, w);
				}
#endif
			}
		}
...
*/
        ...
        h_deepTag_TvsQCD_Wjet_S->Fill(data.FatJet[iBoostMassTag[i]].deepTag_TvsQCD, w);
			...
			if(nJet>=3 && nJet<6){
				...
				h_R2MR_Wjet_S_nj45->Fill(MR*R2, w);
			...
			if(nJet>=6){
				...
				h_R2MR_Wjet_S_nj6->Fill(MR*R2, w);
		...
		w = sf_weight['A'];
		if (apply_all_cuts('A')) {
			h_MR_WZ0b_S->Fill(MR, w);
			h_R2_WZ0b_S->Fill(R2, w);
      h_R2MR_WZ0b_S->Fill(MR*R2, w);
			h_R2_MR_WZ0b_S->Fill(MR, R2, w);
		}
		w = sf_weight['a'];
		if (apply_all_cuts('a')) {
			h_MR_WZc0b_S->Fill(MR, w);
			h_R2_WZc0b_S->Fill(R2, w);
      h_R2MR_WZc0b_S->Fill(MR*R2, w);
			h_R2_MR_WZc0b_S->Fill(MR, R2, w);
		}
		if (apply_all_cuts_except('A', "mDPhi")) {
      h_dPhiRazor_WZ0b_S->Fill(dPhiRazor,w);
      h_mDPhi_WZ0b_S->Fill(minDeltaPhi,w);
      if(minDeltaPhi>=0.5) h_R2_MR_WZ0b_S_mDPhi->Fill(MR, R2, w);
    }
		if (apply_all_cuts_except('a', "mDPhi")) {
      h_dPhiRazor_WZc0b_S->Fill(dPhiRazor,w);
      h_mDPhi_WZc0b_S->Fill(minDeltaPhi,w);
      if(minDeltaPhi>=0.5) h_R2_MR_WZc0b_S_mDPhi->Fill(MR, R2, w);
    }
		...
		if(iscomFFsim){ 
			for (size_t i=0; i<data.FatJet.size(); ++i) {
				if (passBoostMassTag[i]) {
					...
					if (passGenW[i])    h_AK8Jet1Pt_eta_GenW_W->Fill(data.FatJet[i].pt,std::abs(data.FatJet[i].eta),w);
					if (passGenTop[i])  h_AK8Jet1Pt_eta_GenTop_Top->Fill(data.FatJet[i].pt,std::abs(data.FatJet[i].eta),w);
					if (!passGenW[i])   h_AK8Jet1Pt_eta_FakeW_W->Fill(data.FatJet[i].pt,std::abs(data.FatJet[i].eta),w);
					if (!passGenTop[i]) h_AK8Jet1Pt_eta_FakeTop_Top->Fill(data.FatJet[i].pt,std::abs(data.FatJet[i].eta),w);
				}
			}
		}
		...
		if(trigger && isSinglePhoton){
			if(nJetAK8>=1 && nJetNoPho>=2 && R2_pho>=0.08 && MR_pho>=0.08) {
