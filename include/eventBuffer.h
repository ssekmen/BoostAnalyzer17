...
// Created:     Wed Oct 28 06:07:17 2020 by mkanalyzer.py v2.0.1 23-Mar-2019
// Author:      Changgi Huh
//----------------------------------------------------------------------------
#include <stdio.h>
#include <stdlib.h>
...
struct eventBuffer
{
  ...
  float	METFixEE2017_phi_jer;
  float	METFixEE2017_phi_jerDown;
  float	METFixEE2017_phi_jerUp;
  float	METFixEE2017_phi_jesTotalDown;
  float	METFixEE2017_phi_jesTotalUp;
  float	METFixEE2017_phi_nom;
  float	METFixEE2017_phi_unclustEnDown;
  float	METFixEE2017_phi_unclustEnUp;
  float	METFixEE2017_pt;
  float	METFixEE2017_pt_jer;
  float	METFixEE2017_pt_jerDown;
  float	METFixEE2017_pt_jerUp;
  float	METFixEE2017_pt_jesTotalDown;
  float	METFixEE2017_pt_jesTotalUp;
  float	METFixEE2017_pt_nom;
    ...
    choose(std::map<std::string, bool>())
  {
    ...
    choose["METFixEE2017_phi_jer"]	= DEFAULT;
    choose["METFixEE2017_phi_jerDown"]	= DEFAULT;
    choose["METFixEE2017_phi_jerUp"]	= DEFAULT;
    choose["METFixEE2017_phi_jesTotalDown"]	= DEFAULT;
    choose["METFixEE2017_phi_jesTotalUp"]	= DEFAULT;
    choose["METFixEE2017_phi_nom"]	= DEFAULT;
    choose["METFixEE2017_phi_unclustEnDown"]	= DEFAULT;
    choose["METFixEE2017_phi_unclustEnUp"]	= DEFAULT;
    choose["METFixEE2017_pt"]	= DEFAULT;
    choose["METFixEE2017_pt_jer"]	= DEFAULT;
    choose["METFixEE2017_pt_jerDown"]	= DEFAULT;
    choose["METFixEE2017_pt_jerUp"]	= DEFAULT;
    choose["METFixEE2017_pt_jesTotalDown"]	= DEFAULT;
    choose["METFixEE2017_pt_jesTotalUp"]	= DEFAULT;
    choose["METFixEE2017_pt_nom"]	= DEFAULT;
    ...
    if ( choose["METFixEE2017_phi_jer"] )
      input->select("Events/METFixEE2017_phi_jer", 	METFixEE2017_phi_jer);
    if ( choose["METFixEE2017_phi_jerDown"] )
      input->select("Events/METFixEE2017_phi_jerDown",
                     METFixEE2017_phi_jerDown);
    if ( choose["METFixEE2017_phi_jerUp"] )
      input->select("Events/METFixEE2017_phi_jerUp",
                     METFixEE2017_phi_jerUp);
    if ( choose["METFixEE2017_phi_jesTotalDown"] )
      input->select("Events/METFixEE2017_phi_jesTotalDown",
                     METFixEE2017_phi_jesTotalDown);
    if ( choose["METFixEE2017_phi_jesTotalUp"] )
      input->select("Events/METFixEE2017_phi_jesTotalUp",
                     METFixEE2017_phi_jesTotalUp);
    if ( choose["METFixEE2017_phi_nom"] )
      input->select("Events/METFixEE2017_phi_nom", 	METFixEE2017_phi_nom);
    ...
    if ( choose["METFixEE2017_pt_jer"] )
      input->select("Events/METFixEE2017_pt_jer", 	METFixEE2017_pt_jer);
    if ( choose["METFixEE2017_pt_jerDown"] )
      input->select("Events/METFixEE2017_pt_jerDown",
                     METFixEE2017_pt_jerDown);
    if ( choose["METFixEE2017_pt_jerUp"] )
      input->select("Events/METFixEE2017_pt_jerUp", 	METFixEE2017_pt_jerUp);
    if ( choose["METFixEE2017_pt_jesTotalDown"] )
      input->select("Events/METFixEE2017_pt_jesTotalDown",
                     METFixEE2017_pt_jesTotalDown);
    if ( choose["METFixEE2017_pt_jesTotalUp"] )
      input->select("Events/METFixEE2017_pt_jesTotalUp",
                     METFixEE2017_pt_jesTotalUp);
    if ( choose["METFixEE2017_pt_nom"] )
      input->select("Events/METFixEE2017_pt_nom", 	METFixEE2017_pt_nom);
    ...
    output(&stream)
  {
    ...
    output->add("Events/METFixEE2017_phi_jer", 	METFixEE2017_phi_jer);
    output->add("Events/METFixEE2017_phi_jerDown",
                 METFixEE2017_phi_jerDown);
    output->add("Events/METFixEE2017_phi_jerUp", 	METFixEE2017_phi_jerUp);
    output->add("Events/METFixEE2017_phi_jesTotalDown",
                 METFixEE2017_phi_jesTotalDown);
    output->add("Events/METFixEE2017_phi_jesTotalUp",
                 METFixEE2017_phi_jesTotalUp);
    output->add("Events/METFixEE2017_phi_nom", 	METFixEE2017_phi_nom);
    ...
    output->add("Events/METFixEE2017_pt_jer", 	METFixEE2017_pt_jer);
    output->add("Events/METFixEE2017_pt_jerDown", 	METFixEE2017_pt_jerDown);
    output->add("Events/METFixEE2017_pt_jerUp", 	METFixEE2017_pt_jerUp);
    output->add("Events/METFixEE2017_pt_jesTotalDown",
                 METFixEE2017_pt_jesTotalDown);
    output->add("Events/METFixEE2017_pt_jesTotalUp",
                 METFixEE2017_pt_jesTotalUp);
    output->add("Events/METFixEE2017_pt_nom", 	METFixEE2017_pt_nom);
  ...
  void initBuffers()
  {
    CorrT1METJet_area	= std::vector<float>(50,0);
    CorrT1METJet_eta	= std::vector<float>(50,0);
    CorrT1METJet_muonSubtrFactor	= std::vector<float>(50,0);
    CorrT1METJet_phi	= std::vector<float>(50,0);
    CorrT1METJet_rawPt	= std::vector<float>(50,0);
    ...
    FatJet_btagDDBvL_noMD	= std::vector<float>(20,0);
    FatJet_btagDDCvB	= std::vector<float>(20,0);
    FatJet_btagDDCvB_noMD	= std::vector<float>(20,0);
    FatJet_btagDDCvL	= std::vector<float>(20,0);
    FatJet_btagDDCvL_noMD	= std::vector<float>(20,0);
    FatJet_btagDeepB	= std::vector<float>(20,0);
    FatJet_btagHbb	= std::vector<float>(20,0);
    FatJet_corr_JEC	= std::vector<float>(20,0);
    FatJet_corr_JER	= std::vector<float>(20,0);
    FatJet_corr_JMR	= std::vector<float>(20,0);
    FatJet_corr_JMS	= std::vector<float>(20,0);
    ...
    FatJet_electronIdx3SJ	= std::vector<int>(20,0);
    FatJet_eta	= std::vector<float>(20,0);
    FatJet_genJetAK8Idx	= std::vector<int>(20,0);
    FatJet_hadronFlavour	= std::vector<int>(20,0);
    FatJet_jetId	= std::vector<int>(20,0);
    FatJet_lsf3	= std::vector<float>(20,0);
    FatJet_mass	= std::vector<float>(20,0);
    FatJet_mass_jerDown	= std::vector<float>(20,0);
    FatJet_mass_jerUp	= std::vector<float>(20,0);
    FatJet_mass_jesTotalDown	= std::vector<float>(20,0);
    FatJet_mass_jesTotalUp	= std::vector<float>(20,0);
    FatJet_mass_jmrDown	= std::vector<float>(20,0);
    FatJet_mass_jmrUp	= std::vector<float>(20,0);
    FatJet_mass_jmsDown	= std::vector<float>(20,0);
    FatJet_mass_jmsUp	= std::vector<float>(20,0);
    FatJet_mass_nom	= std::vector<float>(20,0);
    FatJet_mass_raw	= std::vector<float>(20,0);
    FatJet_msoftdrop	= std::vector<float>(20,0);
    FatJet_msoftdrop_corr_JMR	= std::vector<float>(20,0);
    FatJet_msoftdrop_corr_JMS	= std::vector<float>(20,0);
    FatJet_msoftdrop_corr_PUPPI	= std::vector<float>(20,0);
    FatJet_msoftdrop_jerDown	= std::vector<float>(20,0);
    FatJet_msoftdrop_jerUp	= std::vector<float>(20,0);
    FatJet_msoftdrop_jesTotalDown	= std::vector<float>(20,0);
    FatJet_msoftdrop_jesTotalUp	= std::vector<float>(20,0);
    FatJet_msoftdrop_jmrDown	= std::vector<float>(20,0);
    FatJet_msoftdrop_jmrUp	= std::vector<float>(20,0);
    FatJet_msoftdrop_jmsDown	= std::vector<float>(20,0);
    FatJet_msoftdrop_jmsUp	= std::vector<float>(20,0);
    FatJet_msoftdrop_nom	= std::vector<float>(20,0);
    FatJet_msoftdrop_raw	= std::vector<float>(20,0);
    FatJet_msoftdrop_tau21DDT_jerDown	= std::vector<float>(20,0);
    FatJet_msoftdrop_tau21DDT_jerUp	= std::vector<float>(20,0);
    FatJet_msoftdrop_tau21DDT_jmrDown	= std::vector<float>(20,0);
    FatJet_msoftdrop_tau21DDT_jmrUp	= std::vector<float>(20,0);
    FatJet_msoftdrop_tau21DDT_jmsDown	= std::vector<float>(20,0);
    FatJet_msoftdrop_tau21DDT_jmsUp	= std::vector<float>(20,0);
    FatJet_msoftdrop_tau21DDT_nom	= std::vector<float>(20,0);
    FatJet_muonIdx3SJ	= std::vector<int>(20,0);
    FatJet_n2b1	= std::vector<float>(20,0);
    FatJet_n3b1	= std::vector<float>(20,0);
    FatJet_nBHadrons	= std::vector<int>(20,0);
    FatJet_nCHadrons	= std::vector<int>(20,0);
    FatJet_phi	= std::vector<float>(20,0);
    FatJet_pt	= std::vector<float>(20,0);
    FatJet_pt_jerDown	= std::vector<float>(20,0);
    FatJet_pt_jerUp	= std::vector<float>(20,0);
    FatJet_pt_jesTotalDown	= std::vector<float>(20,0);
    FatJet_pt_jesTotalUp	= std::vector<float>(20,0);
    FatJet_pt_nom	= std::vector<float>(20,0);
    FatJet_pt_raw	= std::vector<float>(20,0);
    ...
    GenPart_eta	= std::vector<float>(205,0);
    GenPart_genPartIdxMother	= std::vector<int>(205,0);
    GenPart_mass	= std::vector<float>(205,0);
    GenPart_pdgId	= std::vector<int>(205,0);
    GenPart_phi	= std::vector<float>(205,0);
    GenPart_pt	= std::vector<float>(205,0);
    GenPart_status	= std::vector<int>(205,0);
    GenPart_statusFlags	= std::vector<int>(205,0);
    ...
    Jet_area	= std::vector<float>(50,0);
    Jet_bRegCorr	= std::vector<float>(50,0);
    Jet_bRegRes	= std::vector<float>(50,0);
    Jet_btagCMVA	= std::vector<float>(50,0);
    Jet_btagCSVV2	= std::vector<float>(50,0);
    Jet_btagDeepB	= std::vector<float>(50,0);
    Jet_btagDeepC	= std::vector<float>(50,0);
    Jet_btagDeepFlavB	= std::vector<float>(50,0);
    Jet_btagDeepFlavC	= std::vector<float>(50,0);
    Jet_cRegCorr	= std::vector<float>(50,0);
    Jet_cRegRes	= std::vector<float>(50,0);
    Jet_chEmEF	= std::vector<float>(50,0);
    Jet_chFPV0EF	= std::vector<float>(50,0);
    Jet_chFPV1EF	= std::vector<float>(50,0);
    Jet_chFPV2EF	= std::vector<float>(50,0);
    Jet_chFPV3EF	= std::vector<float>(50,0);
    Jet_chHEF	= std::vector<float>(50,0);
    Jet_cleanmask	= std::vector<int>(50,0);
    Jet_corr_JEC	= std::vector<float>(50,0);
    Jet_corr_JER	= std::vector<float>(50,0);
    Jet_electronIdx1	= std::vector<int>(50,0);
    Jet_electronIdx2	= std::vector<int>(50,0);
    Jet_eta	= std::vector<float>(50,0);
    Jet_genJetIdx	= std::vector<int>(50,0);
    Jet_hadronFlavour	= std::vector<int>(50,0);
    Jet_jetId	= std::vector<int>(50,0);
    Jet_mass	= std::vector<float>(50,0);
    Jet_mass_jerDown	= std::vector<float>(50,0);
    Jet_mass_jerUp	= std::vector<float>(50,0);
    Jet_mass_jesTotalDown	= std::vector<float>(50,0);
    Jet_mass_jesTotalUp	= std::vector<float>(50,0);
    Jet_mass_nom	= std::vector<float>(50,0);
    Jet_mass_raw	= std::vector<float>(50,0);
    Jet_muEF	= std::vector<float>(50,0);
    Jet_muonIdx1	= std::vector<int>(50,0);
    Jet_muonIdx2	= std::vector<int>(50,0);
    Jet_muonSubtrFactor	= std::vector<float>(50,0);
    Jet_nConstituents	= std::vector<int>(50,0);
    Jet_nElectrons	= std::vector<int>(50,0);
    Jet_nMuons	= std::vector<int>(50,0);
    Jet_neEmEF	= std::vector<float>(50,0);
    Jet_neHEF	= std::vector<float>(50,0);
    Jet_partonFlavour	= std::vector<int>(50,0);
    Jet_phi	= std::vector<float>(50,0);
    Jet_pt	= std::vector<float>(50,0);
    Jet_pt_jerDown	= std::vector<float>(50,0);
    Jet_pt_jerUp	= std::vector<float>(50,0);
    Jet_pt_jesTotalDown	= std::vector<float>(50,0);
    Jet_pt_jesTotalUp	= std::vector<float>(50,0);
    Jet_pt_nom	= std::vector<float>(50,0);
    Jet_pt_raw	= std::vector<float>(50,0);
    Jet_puId	= std::vector<int>(50,0);
    Jet_puIdDisc	= std::vector<float>(50,0);
    Jet_qgl	= std::vector<float>(50,0);
    Jet_rawFactor	= std::vector<float>(50,0);
    LHEPart_eta	= std::vector<float>(20,0);
    LHEPart_incomingpz	= std::vector<float>(20,0);
    ...
    LHEPart_spin	= std::vector<int>(20,0);
    LHEPart_status	= std::vector<int>(20,0);
    ...
    TrigObj_eta	= std::vector<float>(80,0);
    TrigObj_filterBits	= std::vector<int>(80,0);
    TrigObj_id	= std::vector<int>(80,0);
    TrigObj_l1charge	= std::vector<int>(80,0);
    TrigObj_l1iso	= std::vector<int>(80,0);
    TrigObj_l1pt	= std::vector<float>(80,0);
    TrigObj_l1pt_2	= std::vector<float>(80,0);
    TrigObj_l2pt	= std::vector<float>(80,0);
    TrigObj_phi	= std::vector<float>(80,0);
    TrigObj_pt	= std::vector<float>(80,0);
    CorrT1METJet	= std::vector<eventBuffer::CorrT1METJet_s>(50);
    ...
    GenPart	= std::vector<eventBuffer::GenPart_s>(205);
    ...
    TrigObj	= std::vector<eventBuffer::TrigObj_s>(80);
