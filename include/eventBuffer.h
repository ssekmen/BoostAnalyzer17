...
// Created:     Tue Nov 27 21:59:59 2018 by mkanalyzer.py
// Author:      Changgi Huh
//----------------------------------------------------------------------------
#include <stdio.h>
#include <stdlib.h>
...
struct eventBuffer
{
  ...
  void initBuffers()
  {
    ...
    Electron_convVeto	= std::vector<int>(25,0);
    Electron_cutBased	= std::vector<int>(25,0);
    Electron_cutBased_HEEP	= std::vector<int>(25,0);
    ...
    Electron_isPFcand	= std::vector<int>(25,0);
    ...
    Electron_mvaFall17Iso_WP80	= std::vector<int>(25,0);
    Electron_mvaFall17Iso_WP90	= std::vector<int>(25,0);
    Electron_mvaFall17Iso_WPL	= std::vector<int>(25,0);
    Electron_mvaFall17noIso	= std::vector<float>(25,0);
    Electron_mvaFall17noIso_WP80	= std::vector<int>(25,0);
    Electron_mvaFall17noIso_WP90	= std::vector<int>(25,0);
    Electron_mvaFall17noIso_WPL	= std::vector<int>(25,0);
    ...
    GenDressedLepton_eta	= std::vector<float>(10,0);
    GenDressedLepton_mass	= std::vector<float>(10,0);
    GenDressedLepton_pdgId	= std::vector<int>(10,0);
    GenDressedLepton_phi	= std::vector<float>(10,0);
    GenDressedLepton_pt	= std::vector<float>(10,0);
    ...
    GenPart_eta	= std::vector<float>(215,0);
    GenPart_genPartIdxMother	= std::vector<int>(215,0);
    GenPart_mass	= std::vector<float>(215,0);
    GenPart_pdgId	= std::vector<int>(215,0);
    GenPart_phi	= std::vector<float>(215,0);
    GenPart_pt	= std::vector<float>(215,0);
    GenPart_status	= std::vector<int>(215,0);
    GenPart_statusFlags	= std::vector<int>(215,0);
    ...
    IsoTrack_isHighPurityTrack	= std::vector<int>(20,0);
    IsoTrack_isPFcand	= std::vector<int>(20,0);
    ...
    Jet_bReg	= std::vector<float>(50,0);
    ...
    Tau_idDecayMode	= std::vector<int>(20,0);
    Tau_idDecayModeNewDMs	= std::vector<int>(20,0);
    ...
    GenDressedLepton	= std::vector<eventBuffer::GenDressedLepton_s>(10);
    GenJet	= std::vector<eventBuffer::GenJet_s>(50);
    GenJetAK8	= std::vector<eventBuffer::GenJetAK8_s>(20);
    GenPart	= std::vector<eventBuffer::GenPart_s>(215);
