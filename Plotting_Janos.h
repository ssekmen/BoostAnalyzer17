...
Plotting::define_additional_histos(const Weighting& w, const unsigned int& syst_nSyst, const unsigned int& syst_index) {
  ...
  standard_plots = {"HT", "METFine", "MET", "METFixEE2017", "PuppiMET", "RawMET", "TkMET", "MRFine", "MR", "R2Fine", "R2", "MRR2", "RazorBins", "RazorBinsNew"};
  ...
  for (auto region : {Region::Pre_Had}) {
    ...
    sh.AddHistos("gen hadw",   { .fill="GenMatchedAK8JetIndex_vs_NGenHadW",   .pfs={"Signals_Background",cut}, .cuts={},.draw="COLZ",.opt=o_1or2d_s+"Log",.ranges={}});
    sh.AddHistos("gen hadz",   { .fill="GenMatchedAK8JetIndex_vs_NGenHadZ",   .pfs={"Signals_Background",cut}, .cuts={},.draw="COLZ",.opt=o_1or2d_s+"Log",.ranges={}});
    sh.AddHistos("gen hadtop", { .fill="GenMatchedAK8JetIndex_vs_NGenHadTop", .pfs={"Signals_Background",cut}, .cuts={},.draw="COLZ",.opt=o_1or2d_s+"Log",.ranges={}});
    sh.AddHistos("gen leptop", { .fill="GenMatchedAK8JetIndex_vs_NGenLepTop", .pfs={"Signals_Background",cut}, .cuts={},.draw="COLZ",.opt=o_1or2d_s+"Log",.ranges={}});
    ...
    for (auto data : showdata ) {
      ...
      for (auto nobj_bin : {"NJet45",
        ...
        for (auto std_plot : standard_plots) {
          ...
          sh.AddHistos(s+"evt", { .fill=c+std_plot,                  .pfs={signal,data,cut,nobj_bin,bveto},   .cuts={},.draw=d,.opt=opt,.ranges=r_Stk6});
        ...
        if (nobj_bin != std::string("NJet45")) {
          ...
          sh.AddHistos(s+"evt", { .fill=c+"NJet",                    .pfs={signal,data,cut,nobj_bin,bveto},   .cuts={},.draw=d,.opt=opt,.ranges=r_Stk6});
        ...
        sh.AddHistos(  s+"evt", { .fill=c+"MTBoost",                 .pfs={signal,data,cut,nobj_bin,bveto},           .cuts={},.draw=d,.opt=opt,.ranges=r_Stk6});
  ...
  for (auto region : {Region::Pre_NonIso}) {
    ...
    //showdata.push_back("Blind");
    // Leptons
    sh.AddHistos("evt",    { .fill="NLepNoIso_vs_NGenLepFromTop", .pfs={"Signals_Background",cut+"_Excl1LepMTdPhiJet"}, .cuts={},.draw="COLZ",.opt=o_1or2d_s+"Log",.ranges={}});
    sh.AddHistos("evt",    { .fill="NEleNoIso_vs_NGenEleFromTop", .pfs={"Signals_Background",cut+"_Excl1LepMTdPhiJet"}, .cuts={},.draw="COLZ",.opt=o_1or2d_s+"Log",.ranges={}});
    sh.AddHistos("evt",    { .fill="NMuNoIso_vs_NGenMuFromTop",   .pfs={"Signals_Background",cut+"_Excl1LepMTdPhiJet"}, .cuts={},.draw="COLZ",.opt=o_1or2d_s+"Log",.ranges={}});
    sh.AddHistos("evt",    { .fill="NLepNonIso_vs_NGenLepFromTop",     .pfs={"Signals_Background",cut+"_Excl1LepMTdPhiJet"}, .cuts={},.draw="COLZ",.opt=o_1or2d_s+"Log",.ranges={}});
    sh.AddHistos("evt",    { .fill="NEleNonIso_vs_NGenEleFromTop",     .pfs={"Signals_Background",cut+"_Excl1LepMTdPhiJet"}, .cuts={},.draw="COLZ",.opt=o_1or2d_s+"Log",.ranges={}});
    sh.AddHistos("evt",    { .fill="NMuNonIso_vs_NGenMuFromTop",       .pfs={"Signals_Background",cut+"_Excl1LepMTdPhiJet"}, .cuts={},.draw="COLZ",.opt=o_1or2d_s+"Log",.ranges={}});
    // Boosted jet Index
    sh.AddHistos("hadw",       { .fill="JetAK8Index_vs_HadWIndex",                  .pfs={"Signals_Background",cut,"MatchGenHadW"},   .cuts={},.draw="COLZ",.opt=o_1or2d_s+"Log",.ranges={}});
    sh.AddHistos("hadz",       { .fill="JetAK8Index_vs_HadZIndex",                  .pfs={"Signals_Background",cut,"MatchGenHadZ"},   .cuts={},.draw="COLZ",.opt=o_1or2d_s+"Log",.ranges={}});
    sh.AddHistos("hadtop",     { .fill="JetAK8Index_vs_HadTopIndex",                .pfs={"Signals_Background",cut,"MatchGenHadTop"}, .cuts={},.draw="COLZ",.opt=o_1or2d_s+"Log",.ranges={}});
    ...
    for (auto data : showdata ) {
      ...
      sh.AddHistos(s+"AK8", { .fill=c+"LepJetSubJetDeepB",               .pfs={"StackPlotSignal",data,cut,"LepTopNoSubJetB"},               .cuts={},.draw=d,.opt=opt,.ranges=r_Stk5});
      ...
      sh.AddHistos(s+"AK8", { .fill=c+"LepJetLSFNoIso",                  .pfs={"StackPlotSignal",data,cut+"_Excl1LepMTdPhiJet","LepJetNoIso"}, .cuts={},.draw=d,.opt=opt,.ranges=r_Stk5});
      sh.AddHistos(s+"AK8", { .fill=c+"LepJetDRmin",                     .pfs={"StackPlotSignal",data,cut+"_Excl1LepMTdPhiJet","LepJetNoIso"}, .cuts={},.draw=d,.opt=opt,.ranges=r_Stk5});
      sh.AddHistos(s+"AK8", { .fill=c+"LepJetPtrel",                     .pfs={"StackPlotSignal",data,cut+"_Excl1LepMTdPhiJet","LepJetNoIso"}, .cuts={},.draw=d,.opt=opt,.ranges=r_Stk5});
      ...
      sh.AddHistos(s+"AK8", { .fill=c+"LepTopSubJetDeepB",               .pfs={"StackPlotSignal",data,cut,"LepTopNoSubJetB"},               .cuts={},.draw=d,.opt=opt,.ranges=r_Stk5});
      ...
      sh.AddHistos(s+"AK8", { .fill=c+"LepTopLSFNoIso",                  .pfs={"StackPlotSignal",data,cut+"_Excl1LepMTdPhiJet","LepTopNoIso"}, .cuts={},.draw=d,.opt=opt,.ranges=r_Stk5});
      sh.AddHistos(s+"AK8", { .fill=c+"LepJetDRmin",                     .pfs={"StackPlotSignal",data,cut+"_Excl1LepMTdPhiJet","LepTopNoIso"}, .cuts={},.draw=d,.opt=opt,.ranges=r_Stk5});
      sh.AddHistos(s+"AK8", { .fill=c+"LepJetPtrel",                     .pfs={"StackPlotSignal",data,cut+"_Excl1LepMTdPhiJet","LepTopNoIso"}, .cuts={},.draw=d,.opt=opt,.ranges=r_Stk5});
      for (auto nobj_bin : {"NJet45",
               //"NTop1", "NTop2", "NTop3", "NTop4", "NTop5", 
               //"NWDeepMD1", "NWDeepMD2", "NWDeepMD3", 
               //"NZDeepMD1", "NZDeepMD2", "NZDeepMD3",
        ...
        sh.AddHistos(  s+"evt",  { .fill=c+"DeltaPhi",                .pfs={signal,data,cut+"_ExclMT",nobj_bin},          .cuts={},.draw=d,.opt=opt,.ranges=r_Stk9});
        // MTBoost
        sh.AddHistos(  s+"evt",  { .fill=c+"MTBoost",                 .pfs={signal,data,cut,nobj_bin},                 .cuts={},.draw=d,.opt=opt,.ranges=r_Stk6});
        sh.AddHistos(  s+"evt",  { .fill=c+"MTBoost",                 .pfs={signal,data,cut,nobj_bin,"Nb"},            .cuts={},.draw=d,.opt=opt,.ranges=r_Stk6});
      ...
      for (std::string nhad_bin : {"Nb", "Nisob", "2b", "NHadTop", "NHadW", "NTopDeepMD1", "NTopDeepMD2", "NTopDeep1", "NTopDeep2"}) {
        for (std::string nlep_bin : {"NLepJetCand", "NLepJet", "NLepJetHighMass", "NLepTop", "NLepTopHighMass"}) {
          ...
          for (auto std_plot : standard_plots) {
            ...
            sh.AddHistos(s+"evt", { .fill=c+std_plot,                .pfs={"StackPlotTopSignal",data,cut+"_Excl1LepMTdPhiJet",nhad_bin,nlep_bin}, .cuts={},.draw=d,.opt=opt,.ranges=r_Stk6});
          }
          sh.AddHistos(s+"evt", { .fill=c+"NJet",                    .pfs={"StackPlotTopSignal",data,cut,                  nhad_bin,nlep_bin}, .cuts={},.draw=d,.opt=opt,.ranges=r_Stk6});
          sh.AddHistos(s+"evt", { .fill=c+"NJet",                    .pfs={"StackPlotTopSignal",data,cut+"_Excl1LepMTdPhiJet",nhad_bin,nlep_bin}, .cuts={},.draw=d,.opt=opt,.ranges=r_Stk6});
          ...
          sh.AddHistos(  s+"evt",  { .fill=c+"DeltaPhi",             .pfs={"StackPlotTopSignal",data,cut+"_ExclMT",nhad_bin,nlep_bin},            .cuts={},.draw=d,.opt=opt,.ranges=r_Stk9});
        }
      }
      for (std::string nhad_bin : {"Nb", "Nisob", "2b", "NHadW", "NZDeep1", "NZDeep2", "NZDeep3", "NVDeep1", "NVDeep2", "NVDeep3"}) {
        for (std::string nlep_bin : {"NLepJetCand", "NLepJet", "NLepJetHighMass"}) {
          ...
          for (auto std_plot : standard_plots) {
            ...
            sh.AddHistos(s+"evt", { .fill=c+std_plot,                .pfs={"StackPlotVSignal",data,cut+"_Excl1LepMTdPhiJet",nhad_bin,nlep_bin}, .cuts={},.draw=d,.opt=opt,.ranges=r_Stk6});
          }
          sh.AddHistos(s+"evt", { .fill=c+"NJet",                    .pfs={"StackPlotVSignal",data,cut,                  nhad_bin,nlep_bin}, .cuts={},.draw=d,.opt=opt,.ranges=r_Stk6});
          sh.AddHistos(s+"evt", { .fill=c+"NJet",                    .pfs={"StackPlotVSignal",data,cut+"_Excl1LepMTdPhiJet",nhad_bin,nlep_bin}, .cuts={},.draw=d,.opt=opt,.ranges=r_Stk6});
          ...
          sh.AddHistos(s+"evt",  { .fill=c+"DeltaPhi",               .pfs={"StackPlotVSignal",data,cut+"_ExclMT",           nhad_bin,nlep_bin}, .cuts={},.draw=d,.opt=opt,.ranges=r_Stk9});
        }
      }
    }
    // Gen Truth plots
    for (const auto& cut2 : { cut, cut+"_Excl1LepMTdPhiJet" }) {
      // gen lep/top pt
      sh.AddHistos("gen lep",    { .fill="GenLepPtBins",              .pfs={"Signals_Background",cut2,"GenLepMother","GenLeptonFlavour"}, .cuts={}, .draw="HIST", .opt=o_1or2d_s+"Norm", .ranges={0,0, 0,1, 0.5,0.53} });
      //sh.AddHistos("gen leptop", { .fill="GenLepTopMatchedGenLepPt",  .pfs={"Signals_Background",cut2,"GenTopLeptonFlavour"},             .cuts={}, .draw="HIST", .opt=o_1or2d_s+"Norm", .ranges={0,0, 0,1, 0.5,0.53} }); // Equivalent with above
      ...
      sh.AddHistos("gen leptop", { .fill="GenLepTopMatchedGenLepPt_vs_GenLepTopPt",   .pfs={"Signals_Background",cut2,"GenTopLeptonFlavour"}, .cuts={},.draw="COLZ",.opt=o_1or2d_s+"Log",.ranges={}});
    }
  }
  ...
  for (const auto& regions : magic_enum::enum_entries<Region>()) {
    ...
    if (TString(cut).BeginsWith("CR_")||TString(cut).BeginsWith("Val_")||TString(cut).BeginsWith("Pre_")) {
      ...
      for (auto data : showdata ) {
        ...
        sh.AddHistos(s+"AK4",  { .fill=c+"JetPtBins",                       .pfs={Stack,data,cut}, .cuts={},.draw=d,.opt=opt,.ranges=r_Stk9});
        sh.AddHistos(s+"AK4",  { .fill=c+"JetPt",                           .pfs={Stack,data,cut}, .cuts={},.draw=d,.opt=opt,.ranges=r_Stk9});
        sh.AddHistos(s+"AK4",  { .fill=c+"JetEta",                          .pfs={Stack,data,cut}, .cuts={},.draw=d,.opt=opt,.ranges=r_Stk9});
        sh.AddHistos(s+"AK4",  { .fill=c+"JetPhi",                          .pfs={Stack,data,cut}, .cuts={},.draw=d,.opt=opt,.ranges=r_Stk9});
        sh.AddHistos(s+"AK4",  { .fill=c+"JetDeepB",                        .pfs={Stack,data,cut}, .cuts={},.draw=d,.opt=opt,.ranges=r_Stk9});
        sh.AddHistos("AK4",    { .fill="JetPhotonDR",                       .pfs={Stack,data,cut}, .cuts={},.draw=d,.opt=opt,.ranges=r_Stk9});
        sh.AddHistos("AK4",    { .fill="JetPhotonPtRatio",                  .pfs={Stack,data,cut}, .cuts={},.draw=d,.opt=opt,.ranges=r_Stk9});
        sh.AddHistos("AK4",    { .fill="JetPhotonPtRatio",                  .pfs={Stack,data,cut,"JetPhotonDR0.05"}, .cuts={},.draw=d,.opt=opt,.ranges=r_Stk9});
        sh.AddHistos("AK4",    { .fill="JetPhotonPtRatio",                  .pfs={Stack,data,cut,"JetPhotonDR0.4"},  .cuts={},.draw=d,.opt=opt,.ranges=r_Stk9});
        sh.AddHistos("AK4",    { .fill="JetPhotonDR_vs_JetPhotonPtRatio",   .pfs={"Data_MC",cut},  .cuts={},.draw="COLZ",.opt=o_1or2d_d, .ranges={}});
        sh.AddHistos("AK4",    { .fill="JetEleDR",                          .pfs={Stack,data,cut}, .cuts={},.draw=d,.opt=opt,.ranges=r_Stk9});
        sh.AddHistos("AK4",    { .fill="JetElePtRatio",                     .pfs={Stack,data,cut}, .cuts={},.draw=d,.opt=opt,.ranges=r_Stk9});
        sh.AddHistos("AK4",    { .fill="JetElePtRatio",                     .pfs={Stack,data,cut,"JetEleDR0.05"}, .cuts={},.draw=d,.opt=opt,.ranges=r_Stk9});
        sh.AddHistos("AK4",    { .fill="JetElePtRatio",                     .pfs={Stack,data,cut,"JetEleDR0.4"},  .cuts={},.draw=d,.opt=opt,.ranges=r_Stk9});
        sh.AddHistos("AK4",    { .fill="JetEleDR_vs_JetElePtRatio",         .pfs={"Data_MC",cut},  .cuts={},.draw="COLZ",.opt=o_1or2d_d, .ranges={}});
        sh.AddHistos("AK4",    { .fill="JetMuonDR",                         .pfs={Stack,data,cut}, .cuts={},.draw=d,.opt=opt,.ranges=r_Stk9});
        sh.AddHistos("AK4",    { .fill="JetMuonPtRatio",                    .pfs={Stack,data,cut}, .cuts={},.draw=d,.opt=opt,.ranges=r_Stk9});
        sh.AddHistos("AK4",    { .fill="JetMuonPtRatio",                    .pfs={Stack,data,cut,"JetMuonDR0.05"}, .cuts={},.draw=d,.opt=opt,.ranges=r_Stk9});
        sh.AddHistos("AK4",    { .fill="JetMuonPtRatio",                    .pfs={Stack,data,cut,"JetMuonDR0.4"},  .cuts={},.draw=d,.opt=opt,.ranges=r_Stk9});
  ...
  for (auto region : {Region::Pre, Region::CR_Top17_1Boost, Region::CR_2LepInv, Region::CR_1PhoInv, Region::Val_Signal}) {
    ...
    for (auto data : showdata ) {
      ...
      sh.AddHistos(s+"b",    { .fill=c+"BJetDeepB",           .pfs={Stack,data,cut1}, .cuts={},.draw=d,.opt=opt,.ranges=r_Stk6});
  ...
  for (auto region : {Region::Pre, Region::CR_Top17_1Boost,Region::CR_W17_1Boost,Region::CR_QCD17_1Boost, Region::CR_1LepInv, Region::CR_2LepInv, Region::CR_1PhoInv, Region::CR_Fake, Region::Val_Signal, Region::Val_QCD}) {
	...
	sh.AddHistos(s+"AK8",  { .fill=c+"MaxAK8SubJetDeepB",  .pfs={Stack,data,cut},               .cuts={},.draw=d,.opt=opt,.ranges=r_Stk8});
	...
	sh.AddHistos(s+"AK8",  { .fill=c+"JetAK8DeepTagZvsQCD",    .pfs={Stack,data,cut},               .cuts={},.draw=d,.opt=opt,.ranges=r_Stk8});
	sh.AddHistos(s+"AK8",  { .fill=c+"JetAK8DeepTagMDHbbvsQCD",.pfs={Stack,data,cut},               .cuts={},.draw=d,.opt=opt,.ranges=r_Stk8});
	sh.AddHistos(s+"AK8",  { .fill=c+"JetAK8DeepTagMDWvsQCD",  .pfs={Stack,data,cut},               .cuts={},.draw=d,.opt=opt,.ranges=r_Stk8});
	sh.AddHistos(s+"AK8",  { .fill=c+"JetAK8DeepTagMDTvsQCD",  .pfs={Stack,data,cut},               .cuts={},.draw=d,.opt=opt,.ranges=r_Stk8});

	// Tagged Ws
	// Add W scale factor
	sh.AddHistos(s+"hadw",    { .fill=c+"WPtBins",            .pfs={Stack,data,cut},               .cuts={},.draw=d,.opt=opt,.ranges=r_Stk4});
	sh.AddHistos(s+"hadw",    { .fill=c+"WPt",                .pfs={Stack,data,cut},               .cuts={},.draw=d,.opt=opt,.ranges=r_Stk4});
	sh.AddHistos(s+"hadw",    { .fill=c+"WEta",               .pfs={Stack,data,cut},               .cuts={},.draw=d,.opt=opt,.ranges=r_Stk4});
	sh.AddHistos(s+"hadw",    { .fill=c+"WPhi",               .pfs={Stack,data,cut},               .cuts={},.draw=d,.opt=opt,.ranges=r_Stk4});
	sh.AddHistos(s+"hadw",    { .fill=c+"WTau21",             .pfs={Stack,data,cut},               .cuts={},.draw=d,.opt=Opt,.ranges=r_Stk4});
	sh.AddHistos(s+"hadw",    { .fill=c+"WMass",              .pfs={Stack,data,cut},               .cuts={},.draw=d,.opt=opt,.ranges=r_Stk4});
        
	// Tagged tops
	// Add top scale factor
	sh.AddHistos(s+"hadtop",  { .fill=c+"TopPtBins",          .pfs={Stack,data,cut},               .cuts={},.draw=d,.opt=opt,.ranges=r_Stk4});
	sh.AddHistos(s+"hadtop",  { .fill=c+"TopPt",              .pfs={Stack,data,cut},               .cuts={},.draw=d,.opt=opt,.ranges=r_Stk4});
	sh.AddHistos(s+"hadtop",  { .fill=c+"TopEta",             .pfs={Stack,data,cut},               .cuts={},.draw=d,.opt=opt,.ranges=r_Stk4});
	sh.AddHistos(s+"hadtop",  { .fill=c+"TopPhi",             .pfs={Stack,data,cut},               .cuts={},.draw=d,.opt=opt,.ranges=r_Stk4});
	sh.AddHistos(s+"hadtop",  { .fill=c+"TopTau32",           .pfs={Stack,data,cut},               .cuts={},.draw=d,.opt=opt,.ranges=r_Stk4});
	sh.AddHistos(s+"hadtop",  { .fill=c+"TopMass",            .pfs={Stack,data,cut},               .cuts={},.draw=d,.opt=opt,.ranges=r_Stk4});
      }
    }
  }
