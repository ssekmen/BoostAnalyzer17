...
Plotting::define_additional_histos(const Weighting& w, const unsigned int& syst_nSyst, const unsigned int& syst_index) {
  ...
  for (const auto& cut : {"Baseline"}) {
    for (auto plot : {"LeptonicMeasurements"}) {
      for (auto std_plot : standard_plots)
        sh.AddHistos("evt", { .fill=std_plot,             .pfs={plot,"Year",cut},          .cuts={}, .draw="HIST", .opt=o_1or2d_d+"LogTwoCol23", .ranges={0,0, 1e-1,1e8, 0.35,0.86} });
      sh.AddHistos("evt", { .fill="HT2DBins",             .pfs={plot,"Year",cut},          .cuts={}, .draw="HIST", .opt=o_1or2d_d+"LogTwoCol23", .ranges={0,0, 1e-1,1e8, 0.35,0.86} });
      sh.AddHistos("evt", { .fill="RazorBinsLep",         .pfs={plot,"Year",cut},          .cuts={}, .draw="HIST", .opt=o_1or2d_d+"LogTwoCol23", .ranges={0,0, 1e-1,1e8, 0.35,0.86} });
      sh.AddHistos("evt", { .fill="EleNoIsoPt",           .pfs={plot,"Year",cut},          .cuts={}, .draw="HIST", .opt=o_1or2d_d+"LogTwoCol23", .ranges={0,0, 1e-1,1e8, 0.35,0.86} });
      sh.AddHistos("evt", { .fill="MuNoIsoPt",            .pfs={plot,"Year",cut},          .cuts={}, .draw="HIST", .opt=o_1or2d_d+"LogTwoCol23", .ranges={0,0, 1e-1,1e8, 0.35,0.86} });
      sh.AddHistos("evt", { .fill="EleNonIsoPt",          .pfs={plot,"Year",cut},          .cuts={}, .draw="HIST", .opt=o_1or2d_d+"LogTwoCol23", .ranges={0,0, 1e-1,1e8, 0.35,0.86} });
      sh.AddHistos("evt", { .fill="MuNonIsoPt",           .pfs={plot,"Year",cut},          .cuts={}, .draw="HIST", .opt=o_1or2d_d+"LogTwoCol23", .ranges={0,0, 1e-1,1e8, 0.35,0.86} });
      for (auto ele_trigger : std::vector<std::string>({"HLTEff_Ele35", "HLTEff_Ele115", "HLTEff_Ele35_or_Ele115"})) {
        for (auto std_plot : standard_plots)
          sh.AddHistos("evt", { .fill=ele_trigger+"_vs_"+std_plot,             .pfs={plot,"Year",cut,"1Ele"}, .cuts={}, .draw="PE1",  .opt=o_1or2d_d+"TwoCol23", .ranges={0,0, 0,0, 0.5,0.5} });
        sh.AddHistos("evt", { .fill=ele_trigger+"_vs_Bin",                     .pfs={plot,"Year",cut,"1Ele"}, .cuts={}, .draw="PE1",  .opt=o_1or2d_d+"TwoCol23", .ranges={0,0, 0,1, 0.5,0.5} });
        sh.AddHistos("evt", { .fill=ele_trigger+"_vs_RazorBinsLep",            .pfs={plot,"Year",cut,"1Ele"}, .cuts={}, .draw="PE1",  .opt=o_1or2d_d+"TwoCol23", .ranges={0,0, 0,1, 0.5,0.5} });
        sh.AddHistos("evt", { .fill=ele_trigger+"_vs_HT2DBins",                .pfs={plot,"Year",cut,"1Ele"}, .cuts={}, .draw="PE1",  .opt=o_1or2d_d+"TwoCol23", .ranges={0,0, 0,1, 0.5,0.53} });
      }
      for (auto mu_trigger : std::vector<std::string>({"HLTEff_IsoMu27", "HLTEff_Mu50", "HLTEff_IsoMu27_or_Mu50"})) {
        for (auto std_plot : standard_plots)
          sh.AddHistos("evt", { .fill=mu_trigger+"_vs_"+std_plot,             .pfs={plot,"Year",cut,"1Muon"}, .cuts={}, .draw="PE1",  .opt=o_1or2d_d+"TwoCol23", .ranges={0,0, 0,0, 0.5,0.5} });
        sh.AddHistos("evt", { .fill=mu_trigger+"_vs_Bin",                     .pfs={plot,"Year",cut,"1Muon"}, .cuts={}, .draw="PE1",  .opt=o_1or2d_d+"TwoCol23", .ranges={0,0, 0,1, 0.5,0.5} });
        sh.AddHistos("evt", { .fill=mu_trigger+"_vs_RazorBinsLep",            .pfs={plot,"Year",cut,"1Muon"}, .cuts={}, .draw="PE1",  .opt=o_1or2d_d+"TwoCol23", .ranges={0,0, 0,1, 0.5,0.5} });
        sh.AddHistos("evt", { .fill=mu_trigger+"_vs_HT2DBins",                .pfs={plot,"Year",cut,"1Muon"}, .cuts={}, .draw="PE1",  .opt=o_1or2d_d+"TwoCol23", .ranges={0,0, 0,1, 0.5,0.53} });
      }
      for (auto lep_trigger : std::vector<std::string>({"HLTEff_Ele35", "HLTEff_Ele115", "HLTEff_Ele35_or_Ele115"})) {
        for (auto std_plot : standard_plots)
          sh.AddHistos("evt", { .fill=lep_trigger+"_vs_"+std_plot,             .pfs={plot,"Year",cut,"1Ele"}, .cuts={}, .draw="PE1",  .opt=o_1or2d_d+"TwoCol23", .ranges={0,0, 0,0, 0.5,0.5} });
        sh.AddHistos("evt", { .fill=lep_trigger+"_vs_Bin",                     .pfs={plot,"Year",cut,"1Ele"}, .cuts={}, .draw="PE1",  .opt=o_1or2d_d+"TwoCol23", .ranges={0,0, 0,1, 0.5,0.5} });
        sh.AddHistos("evt", { .fill=lep_trigger+"_vs_RazorBinsLep",            .pfs={plot,"Year",cut,"1Ele"}, .cuts={}, .draw="PE1",  .opt=o_1or2d_d+"TwoCol23", .ranges={0,0, 0,1, 0.5,0.5} });
        sh.AddHistos("evt", { .fill=lep_trigger+"_vs_ElePt",                   .pfs={plot,"Year",cut,"1Ele"}, .cuts={}, .draw="PE1",  .opt=o_1or2d_d+"TwoCol23", .ranges={0,0, 0,1, 0.5,0.53} });
      }
      for (auto lep_trigger : std::vector<std::string>({"HLTEff_IsoMu27", "HLTEff_Mu50", "HLTEff_IsoMu27_or_Mu50"})) {
        for (auto std_plot : standard_plots)
          sh.AddHistos("evt", { .fill=lep_trigger+"_vs_"+std_plot,             .pfs={plot,"Year",cut,"1Muon"}, .cuts={}, .draw="PE1",  .opt=o_1or2d_d+"TwoCol23", .ranges={0,0, 0,0, 0.5,0.5} });
        sh.AddHistos("evt", { .fill=lep_trigger+"_vs_Bin",                     .pfs={plot,"Year",cut,"1Muon"}, .cuts={}, .draw="PE1",  .opt=o_1or2d_d+"TwoCol23", .ranges={0,0, 0,1, 0.5,0.5} });
        sh.AddHistos("evt", { .fill=lep_trigger+"_vs_RazorBinsLep",            .pfs={plot,"Year",cut,"1Muon"}, .cuts={}, .draw="PE1",  .opt=o_1or2d_d+"TwoCol23", .ranges={0,0, 0,1, 0.5,0.5} });
        sh.AddHistos("evt", { .fill=lep_trigger+"_vs_MuPt",                    .pfs={plot,"Year",cut,"1Muon"}, .cuts={}, .draw="PE1",  .opt=o_1or2d_d+"TwoCol23", .ranges={0,0, 0,1, 0.5,0.53} });
      }
      ...
      sh.AddHistos("evt", { .fill="HT1ElePt",             .pfs={plot,"Year",cut},          .cuts={}, .draw="HIST", .opt=o_1or2d_d, .ranges={0,0, 0,0, 0.35,0.86} });
      sh.AddHistos("evt", { .fill="HT2ElePt",             .pfs={plot,"Year",cut},          .cuts={}, .draw="HIST", .opt=o_1or2d_d, .ranges={0,0, 0,0, 0.35,0.86} });
      sh.AddHistos("evt", { .fill="HT3ElePt",             .pfs={plot,"Year",cut},          .cuts={}, .draw="HIST", .opt=o_1or2d_d, .ranges={0,0, 0,0, 0.35,0.86} });
      ...
      sh.AddHistos("evt", { .fill="HT1MuPt",              .pfs={plot,"Year",cut},          .cuts={}, .draw="HIST", .opt=o_1or2d_d, .ranges={0,0, 0,0, 0.35,0.86} });
      sh.AddHistos("evt", { .fill="HT2MuPt",              .pfs={plot,"Year",cut},          .cuts={}, .draw="HIST", .opt=o_1or2d_d, .ranges={0,0, 0,0, 0.35,0.86} });
      sh.AddHistos("evt", { .fill="HT3MuPt",              .pfs={plot,"Year",cut},          .cuts={}, .draw="HIST", .opt=o_1or2d_d, .ranges={0,0, 0,0, 0.35,0.86} });
      for (auto ele_trigger : std::vector<std::string>({"HLTEff_Ele15_HT450", "HLTEff_Ele35_or_Ele115_or_Ele15_HT450"})) {
        ...
        sh.AddHistos("evt", { .fill=ele_trigger+"_vs_HT3ElePt",                .pfs={plot,"Year",cut,"1Ele"}, .cuts={}, .draw="PE1",  .opt=o_1or2d_d, .ranges={0,0, 0,1, 0.5,0.53} });
      }
      for (auto mu_trigger : std::vector<std::string>({"HLTEff_Mu15_HT450", "HLTEff_IsoMu27_or_Mu50_or_Mu15_HT450"})) {
        ...
        sh.AddHistos("evt", { .fill=mu_trigger+"_vs_HT3MuPt",                 .pfs={plot,"Year",cut,"1Muon"}, .cuts={}, .draw="PE1",  .opt=o_1or2d_d, .ranges={0,0, 0,1, 0.5,0.53} });
      }
    }
  }
  ...
  for (auto region : {Region::Pre_Had}) {
    ...
    for (auto data : showdata ) {
      ...
      for (auto nobj_bin : {"NJet45",
        ...
        for (auto std_plot : standard_plots) {
          sh.AddHistos(s+"evt", { .fill=c+std_plot,                  .pfs={signal,data,"Year",cut,nobj_bin},         .cuts={},.draw=d,.opt=opt,.ranges=r_Stk6});
          //sh.AddHistos(s+"evt", { .fill=c+std_plot,                  .pfs={signal,data,"Year",cut,nobj_bin,"Nb"},    .cuts={},.draw=d,.opt=opt,.ranges=r_Stk6});
          //sh.AddHistos(s+"evt", { .fill=c+std_plot,                  .pfs={signal,data,"Year",cut,nobj_bin,bveto},   .cuts={},.draw=d,.opt=opt,.ranges=r_Stk6});
          //sh.AddHistos(s+"evt", { .fill=c+std_plot,                  .pfs={signal,data,"Year",cut,nobj_bin,"2b"},    .cuts={},.draw=d,.opt=opt,.ranges=r_Stk6});
          //sh.AddHistos(s+"evt", { .fill=c+std_plot,                  .pfs={signal,data,"Year",cut,nobj_bin,"MTBoost800"},    .cuts={},.draw=d,.opt=opt,.ranges=r_Stk6});
        }
        if (nobj_bin != std::string("NJet45")) {
          sh.AddHistos(s+"evt", { .fill=c+"NJet",                    .pfs={signal,data,"Year",cut,nobj_bin},         .cuts={},.draw=d,.opt=opt,.ranges=r_Stk6});
          //sh.AddHistos(s+"evt", { .fill=c+"NJet",                    .pfs={signal,data,"Year",cut,nobj_bin,"Nb"},    .cuts={},.draw=d,.opt=opt,.ranges=r_Stk6});
          //sh.AddHistos(s+"evt", { .fill=c+"NJet",                    .pfs={signal,data,"Year",cut,nobj_bin,bveto},   .cuts={},.draw=d,.opt=opt,.ranges=r_Stk6});
          //sh.AddHistos(s+"evt", { .fill=c+"NJet",                    .pfs={signal,data,"Year",cut,nobj_bin,"2b"},    .cuts={},.draw=d,.opt=opt,.ranges=r_Stk6});
          //sh.AddHistos(s+"evt", { .fill=c+"NJet",                    .pfs={signal,data,"Year",cut,nobj_bin,"MTBoost800"},    .cuts={},.draw=d,.opt=opt,.ranges=r_Stk6});
        }
        sh.AddHistos(  s+"evt", { .fill=c+"DeltaPhi",                .pfs={signal,data,"Year",cut+"_ExcldPhi",nobj_bin},      .cuts={},.draw=d,.opt=opt,.ranges=r_Stk9});
        // MTBoost
        sh.AddHistos(  s+"evt", { .fill=c+"MTBoost",                 .pfs={signal,data,"Year",cut,nobj_bin},                 .cuts={},.draw=d,.opt=opt,.ranges=r_Stk6});
        //sh.AddHistos(  s+"evt", { .fill=c+"MTBoost",                 .pfs={signal,data,"Year",cut,nobj_bin,"Nb"},            .cuts={},.draw=d,.opt=opt,.ranges=r_Stk6});
        //sh.AddHistos(  s+"evt", { .fill=c+"MTBoost",                 .pfs={signal,data,"Year",cut,nobj_bin,bveto},           .cuts={},.draw=d,.opt=opt,.ranges=r_Stk6});
        //sh.AddHistos(  s+"evt", { .fill=c+"MTBoost",                 .pfs={signal,data,"Year",cut,nobj_bin,"2b"},            .cuts={},.draw=d,.opt=opt,.ranges=r_Stk6});
      }
      ...
      //    opt  = (data=="Blind") ? o_stk_s_T : o_stk_d_T;
      //    for (auto std_plot : standard_plots)
      //      sh.AddHistos(s+"evt", { .fill=c+std_plot,                .pfs={"StackPlotTopSignal",data,"Year",cut,nobj_bin,nw_bin},  .cuts={},.draw=d,.opt=opt,.ranges=r_Stk6});
      //    sh.AddHistos(s+"evt", { .fill=c+"NJet",                    .pfs={"StackPlotTopSignal",data,"Year",cut,nobj_bin,nw_bin},  .cuts={},.draw=d,.opt=opt,.ranges=r_Stk6});
      //    sh.AddHistos(s+"evt", { .fill=c+"MTBoost",                 .pfs={"StackPlotTopSignal",data,"Year",cut,nobj_bin,nw_bin},  .cuts={},.draw=d,.opt=opt,.ranges=r_Stk6});
      //    sh.AddHistos(s+"evt", { .fill=c+"DeltaPhi",                .pfs={"StackPlotTopSignal",data,"Year",cut+"_ExcldPhi",nobj_bin,nw_bin}, .cuts={},.draw=d,.opt=opt,.ranges=r_Stk9});
      //  }
      //}
    }
  }
  ...
  for (auto region : {Region::Pre_NonIso}) {
    ...
    for (auto data : showdata ) {
      ...
      sh.AddHistos(s+"AK8", { .fill=c+"LepJetPt",                        .pfs={"StackPlotSignal",data,"Year",cut,"LepJetNoPt"},                    .cuts={},.draw=d,.opt=opt,.ranges=r_Stk5});
      sh.AddHistos(s+"AK8", { .fill=c+"LepJetPt",                        .pfs={"StackPlotSignal",data,"Year",cut,"LepJetHighMass"},                .cuts={},.draw=d,.opt=opt,.ranges=r_Stk5});
      sh.AddHistos(s+"AK8", { .fill=c+"LepJetEta",                       .pfs={"StackPlotSignal",data,"Year",cut,"LepJet"},                        .cuts={},.draw=d,.opt=opt,.ranges=r_Stk5});
      sh.AddHistos(s+"AK8", { .fill=c+"LepJetPhi",                       .pfs={"StackPlotSignal",data,"Year",cut,"LepJet"},                        .cuts={},.draw=d,.opt=opt,.ranges=r_Stk5});
      sh.AddHistos(s+"AK8", { .fill=c+"LepJetMass",                      .pfs={"StackPlotSignal",data,"Year",cut,"LepJetCand"},                    .cuts={},.draw=d,.opt=opt,.ranges=r_Stk5});
      sh.AddHistos(s+"AK8", { .fill=c+"LepJetSubJetDeepB",               .pfs={"StackPlotSignal",data,"Year",cut,"LepTopNoSubJetB"},               .cuts={},.draw=d,.opt=opt,.ranges=r_Stk5});
      sh.AddHistos(s+"AK8", { .fill=c+"LepJetTau21",                     .pfs={"StackPlotSignal",data,"Year",cut,"LepJet"},                        .cuts={},.draw=d,.opt=opt,.ranges=r_Stk5});
      sh.AddHistos(s+"AK8", { .fill=c+"LepJetLSF",                       .pfs={"StackPlotSignal",data,"Year",cut,"LepJet"},                        .cuts={},.draw=d,.opt=opt,.ranges=r_Stk5});
      sh.AddHistos(s+"AK8", { .fill=c+"LepJetNSubJet",                   .pfs={"StackPlotSignal",data,"Year",cut,"LepJet"},                        .cuts={},.draw=d,.opt=opt,.ranges=r_Stk5});
      //sh.AddHistos(s+"AK8", { .fill=c+"LepJetLSFNoIso",                  .pfs={"StackPlotSignal",data,"Year",cut+"_Excl1LepMTdPhiJet","LepJetNoIso"}, .cuts={},.draw=d,.opt=opt,.ranges=r_Stk5});
      //sh.AddHistos(s+"AK8", { .fill=c+"LepJetDRmin",                     .pfs={"StackPlotSignal",data,"Year",cut+"_Excl1LepMTdPhiJet","LepJetNoIso"}, .cuts={},.draw=d,.opt=opt,.ranges=r_Stk5});
      //sh.AddHistos(s+"AK8", { .fill=c+"LepJetPtrel",                     .pfs={"StackPlotSignal",data,"Year",cut+"_Excl1LepMTdPhiJet","LepJetNoIso"}, .cuts={},.draw=d,.opt=opt,.ranges=r_Stk5});
      // Boosted leptonic tops
      sh.AddHistos(s+"AK8", { .fill=c+"LepTopPt",                        .pfs={"StackPlotSignal",data,"Year",cut,"LepTopNoPt"},                    .cuts={},.draw=d,.opt=opt,.ranges=r_Stk5});
      sh.AddHistos(s+"AK8", { .fill=c+"LepTopPt",                        .pfs={"StackPlotSignal",data,"Year",cut,"LepTopHighMass"},                .cuts={},.draw=d,.opt=opt,.ranges=r_Stk5});
      sh.AddHistos(s+"AK8", { .fill=c+"LepTopEta",                       .pfs={"StackPlotSignal",data,"Year",cut,"LepTop"},                        .cuts={},.draw=d,.opt=opt,.ranges=r_Stk5});
      sh.AddHistos(s+"AK8", { .fill=c+"LepTopPhi",                       .pfs={"StackPlotSignal",data,"Year",cut,"LepTop"},                        .cuts={},.draw=d,.opt=opt,.ranges=r_Stk5});
      sh.AddHistos(s+"AK8", { .fill=c+"LepTopMass",                      .pfs={"StackPlotSignal",data,"Year",cut,"LepTopNoMass"},                  .cuts={},.draw=d,.opt=opt,.ranges=r_Stk5});
      sh.AddHistos(s+"AK8", { .fill=c+"LepTopSubJetDeepB",               .pfs={"StackPlotSignal",data,"Year",cut,"LepTopNoSubJetB"},               .cuts={},.draw=d,.opt=opt,.ranges=r_Stk5});
      sh.AddHistos(s+"AK8", { .fill=c+"LepTopTau21",                     .pfs={"StackPlotSignal",data,"Year",cut,"LepTop"},                        .cuts={},.draw=d,.opt=opt,.ranges=r_Stk5});
      sh.AddHistos(s+"AK8", { .fill=c+"LepTopLSF",                       .pfs={"StackPlotSignal",data,"Year",cut,"LepTop"},                        .cuts={},.draw=d,.opt=opt,.ranges=r_Stk5});
      sh.AddHistos(s+"AK8", { .fill=c+"LepTopNSubJet",                   .pfs={"StackPlotSignal",data,"Year",cut,"LepTop"},                        .cuts={},.draw=d,.opt=opt,.ranges=r_Stk5});
      //sh.AddHistos(s+"AK8", { .fill=c+"LepTopLSFNoIso",                  .pfs={"StackPlotSignal",data,"Year",cut+"_Excl1LepMTdPhiJet","LepTopNoIso"}, .cuts={},.draw=d,.opt=opt,.ranges=r_Stk5});
      //sh.AddHistos(s+"AK8", { .fill=c+"LepJetDRmin",                     .pfs={"StackPlotSignal",data,"Year",cut+"_Excl1LepMTdPhiJet","LepTopNoIso"}, .cuts={},.draw=d,.opt=opt,.ranges=r_Stk5});
      //sh.AddHistos(s+"AK8", { .fill=c+"LepJetPtrel",                     .pfs={"StackPlotSignal",data,"Year",cut+"_Excl1LepMTdPhiJet","LepTopNoIso"}, .cuts={},.draw=d,.opt=opt,.ranges=r_Stk5});
      for (auto nobj_bin : {"NJet45",
               //"NTop1", "NTop2", "NTop3", "NTop4", "NTop5", 
               //"NWDeepMD1", "NWDeepMD2", "NWDeepMD3", 
               //"NZDeepMD1", "NZDeepMD2", "NZDeepMD3",
        ...
        for (auto std_plot : standard_plots) {
          sh.AddHistos(s+"evt",  { .fill=c+std_plot,                  .pfs={signal,data,"Year",cut,nobj_bin},         .cuts={},.draw=d,.opt=opt,.ranges=r_Stk6});
          //sh.AddHistos(s+"evt",  { .fill=c+std_plot,                  .pfs={signal,data,"Year",cut,nobj_bin,"Nb"},    .cuts={},.draw=d,.opt=opt,.ranges=r_Stk6});
          //sh.AddHistos(s+"evt",  { .fill=c+std_plot,                  .pfs={signal,data,"Year",cut,nobj_bin,"Nisob"}, .cuts={},.draw=d,.opt=opt,.ranges=r_Stk6});
          //sh.AddHistos(s+"evt",  { .fill=c+std_plot,                  .pfs={signal,data,"Year",cut,nobj_bin,"2b"},    .cuts={},.draw=d,.opt=opt,.ranges=r_Stk6});
          //sh.AddHistos(s+"evt",  { .fill=c+std_plot,                  .pfs={signal,data,"Year",cut,nobj_bin,"MTBoost800"}, .cuts={},.draw=d,.opt=opt,.ranges=r_Stk6});
        }
        if (nobj_bin != std::string("NJet45")) {
          sh.AddHistos(s+"evt",  { .fill=c+"NJet",                    .pfs={signal,data,"Year",cut,nobj_bin},         .cuts={},.draw=d,.opt=opt,.ranges=r_Stk6});
          //sh.AddHistos(s+"evt",  { .fill=c+"NJet",                    .pfs={signal,data,"Year",cut,nobj_bin,"Nb"},    .cuts={},.draw=d,.opt=opt,.ranges=r_Stk6});
          //sh.AddHistos(s+"evt",  { .fill=c+"NJet",                    .pfs={signal,data,"Year",cut,nobj_bin,"Nisob"}, .cuts={},.draw=d,.opt=opt,.ranges=r_Stk6});
          //sh.AddHistos(s+"evt",  { .fill=c+"NJet",                    .pfs={signal,data,"Year",cut,nobj_bin,"2b"},    .cuts={},.draw=d,.opt=opt,.ranges=r_Stk6});
          //sh.AddHistos(s+"evt",  { .fill=c+"NJet",                    .pfs={signal,data,"Year",cut,nobj_bin,"MTBoost800"},    .cuts={},.draw=d,.opt=opt,.ranges=r_Stk6});
        }
        sh.AddHistos(  s+"evt",  { .fill=c+"DeltaPhi",                .pfs={signal,data,"Year",cut,nobj_bin},                 .cuts={},.draw=d,.opt=opt,.ranges=r_Stk9});
        sh.AddHistos(  s+"evt",  { .fill=c+"DeltaPhi",                .pfs={signal,data,"Year",cut+"_ExclMT",nobj_bin},          .cuts={},.draw=d,.opt=opt,.ranges=r_Stk9});
        // MTBoost
        sh.AddHistos(  s+"evt",  { .fill=c+"MTBoost",                 .pfs={signal,data,"Year",cut,nobj_bin},                 .cuts={},.draw=d,.opt=opt,.ranges=r_Stk6});
        //sh.AddHistos(  s+"evt",  { .fill=c+"MTBoost",                 .pfs={signal,data,"Year",cut,nobj_bin,"Nb"},            .cuts={},.draw=d,.opt=opt,.ranges=r_Stk6});
        //sh.AddHistos(  s+"evt",  { .fill=c+"MTBoost",                 .pfs={signal,data,"Year",cut,nobj_bin,"Nisob"},         .cuts={},.draw=d,.opt=opt,.ranges=r_Stk6});
        //sh.AddHistos(  s+"evt",  { .fill=c+"MTBoost",                 .pfs={signal,data,"Year",cut,nobj_bin,"2b"},            .cuts={},.draw=d,.opt=opt,.ranges=r_Stk6});
      }
      ...
      //    opt  = (data=="Blind") ? o_stk_s_T : o_stk_d_T;
      //    for (auto std_plot : standard_plots) {
      //      sh.AddHistos(s+"evt", { .fill=c+std_plot,                .pfs={"StackPlotTopSignal",data,"Year",cut,                  nhad_bin,nlep_bin}, .cuts={},.draw=d,.opt=opt,.ranges=r_Stk6});
      //      sh.AddHistos(s+"evt", { .fill=c+std_plot,                .pfs={"StackPlotTopSignal",data,"Year",cut+"_Excl1LepMTdPhiJet",nhad_bin,nlep_bin}, .cuts={},.draw=d,.opt=opt,.ranges=r_Stk6});
      //    }
      //    sh.AddHistos(s+"evt", { .fill=c+"NJet",                    .pfs={"StackPlotTopSignal",data,"Year",cut,                  nhad_bin,nlep_bin}, .cuts={},.draw=d,.opt=opt,.ranges=r_Stk6});
      //    sh.AddHistos(s+"evt", { .fill=c+"NJet",                    .pfs={"StackPlotTopSignal",data,"Year",cut+"_Excl1LepMTdPhiJet",nhad_bin,nlep_bin}, .cuts={},.draw=d,.opt=opt,.ranges=r_Stk6});
      //    sh.AddHistos(s+"evt",    { .fill=c+"MTBoost",              .pfs={"StackPlotTopSignal",data,"Year",cut,                  nhad_bin,nlep_bin}, .cuts={},.draw=d,.opt=opt,.ranges=r_Stk5});
      //    sh.AddHistos(  s+"evt",  { .fill=c+"DeltaPhi",             .pfs={"StackPlotTopSignal",data,"Year",cut,       nhad_bin,nlep_bin},            .cuts={},.draw=d,.opt=opt,.ranges=r_Stk9});
      //    sh.AddHistos(  s+"evt",  { .fill=c+"DeltaPhi",             .pfs={"StackPlotTopSignal",data,"Year",cut+"_ExclMT",nhad_bin,nlep_bin},            .cuts={},.draw=d,.opt=opt,.ranges=r_Stk9});
      //  }
      //}
      ...
      //    opt  = (data=="Blind") ? o_stk_s_V : o_stk_d_V;
      //    for (auto std_plot : standard_plots) {
      //      sh.AddHistos(s+"evt", { .fill=c+std_plot,                .pfs={"StackPlotVSignal",data,"Year",cut,                  nhad_bin,nlep_bin}, .cuts={},.draw=d,.opt=opt,.ranges=r_Stk6});
      //      sh.AddHistos(s+"evt", { .fill=c+std_plot,                .pfs={"StackPlotVSignal",data,"Year",cut+"_Excl1LepMTdPhiJet",nhad_bin,nlep_bin}, .cuts={},.draw=d,.opt=opt,.ranges=r_Stk6});
      //    }
      //    sh.AddHistos(s+"evt", { .fill=c+"NJet",                    .pfs={"StackPlotVSignal",data,"Year",cut,                  nhad_bin,nlep_bin}, .cuts={},.draw=d,.opt=opt,.ranges=r_Stk6});
      //    sh.AddHistos(s+"evt", { .fill=c+"NJet",                    .pfs={"StackPlotVSignal",data,"Year",cut+"_Excl1LepMTdPhiJet",nhad_bin,nlep_bin}, .cuts={},.draw=d,.opt=opt,.ranges=r_Stk6});
      //    sh.AddHistos(s+"evt", { .fill=c+"MTBoost",                 .pfs={"StackPlotVSignal",data,"Year",cut,                  nhad_bin,nlep_bin}, .cuts={},.draw=d,.opt=opt,.ranges=r_Stk5});
      //    sh.AddHistos(s+"evt",  { .fill=c+"DeltaPhi",               .pfs={"StackPlotVSignal",data,"Year",cut,                  nhad_bin,nlep_bin}, .cuts={},.draw=d,.opt=opt,.ranges=r_Stk9});
      //    sh.AddHistos(s+"evt",  { .fill=c+"DeltaPhi",               .pfs={"StackPlotVSignal",data,"Year",cut+"_ExclMT",           nhad_bin,nlep_bin}, .cuts={},.draw=d,.opt=opt,.ranges=r_Stk9});
      //  }
      //}
    }
    // Gen Truth plots
  ...
  for (auto region : {Region::SR_Had_1htop, Region::SR_Had_2htop, Region::SR_Had_V_b_45j, Region::SR_Had_V_b_6j, Region::SR_Had_1V_0b_34j, Region::SR_Had_1V_0b_5j, Region::SR_Had_2V_0b_24j, Region::SR_Had_2V_0b_5j, 
    ...
    for (auto data : showdata ) {
      ...
      // Masses
      sh.AddHistos(  s+"hadtop", { .fill=c+"HadTopMass",              .pfs={signal,data,"Year",cut},               .cuts={},.draw=d,.opt=opt,.ranges=r_Stk5});
      sh.AddHistos(  s+"leptop", { .fill=c+"LepTopMass",              .pfs={signal,data,"Year",cut},               .cuts={},.draw=d,.opt=opt,.ranges=r_Stk5});
      sh.AddHistos(  s+"hadw",   { .fill=c+"HadWMass",                .pfs={signal,data,"Year",cut},               .cuts={},.draw=d,.opt=opt,.ranges=r_Stk5});
      sh.AddHistos(  s+"hadz",   { .fill=c+"HadZMass",                .pfs={signal,data,"Year",cut},               .cuts={},.draw=d,.opt=opt,.ranges=r_Stk5});
      sh.AddHistos(  s+"hadh",   { .fill=c+"HadHMass",                .pfs={signal,data,"Year",cut},               .cuts={},.draw=d,.opt=opt,.ranges=r_Stk5});
    }
  }
  ...
  for (auto region : {Region::SR_Lep_1htop, Region::SR_Lep_V_b, Region::SR_Lep_V_0b, Region::SR_Lep_H_b, Region::SR_Lep_H_0b}) {
    ...
    for (auto data : showdata ) {
      ...
      // Masses
      sh.AddHistos(  s+"hadtop", { .fill=c+"HadTopMass",              .pfs={signal,data,"Year",cut},               .cuts={},.draw=d,.opt=opt,.ranges=r_Stk8});
      sh.AddHistos(  s+"leptop", { .fill=c+"LepTopMass",              .pfs={signal,data,"Year",cut},               .cuts={},.draw=d,.opt=opt,.ranges=r_Stk8});
      sh.AddHistos(  s+"hadw",   { .fill=c+"HadWMass",                .pfs={signal,data,"Year",cut},               .cuts={},.draw=d,.opt=opt,.ranges=r_Stk8});
      sh.AddHistos(  s+"hadz",   { .fill=c+"HadZMass",                .pfs={signal,data,"Year",cut},               .cuts={},.draw=d,.opt=opt,.ranges=r_Stk8});
      sh.AddHistos(  s+"hadh",   { .fill=c+"HadHMass",                .pfs={signal,data,"Year",cut},               .cuts={},.draw=d,.opt=opt,.ranges=r_Stk8});
    }
  }
  ...
  for (const auto& regions : magic_enum::enum_entries<Region>()) {
    ...
    if (TString(cut).BeginsWith("CR_")||TString(cut).BeginsWith("Val_")||TString(cut).BeginsWith("Pre_")) {
      ...
      for (auto data : showdata ) {
        ...
        sh.AddHistos(s+"AK4",  { .fill=c+"JetPtBins",                       .pfs={Stack,data,"Year",cut}, .cuts={},.draw=d,.opt=opt,.ranges=r_Stk9});
        sh.AddHistos(s+"AK4",  { .fill=c+"JetPt",                           .pfs={Stack,data,"Year",cut}, .cuts={},.draw=d,.opt=opt,.ranges=r_Stk9});
        sh.AddHistos(s+"AK4",  { .fill=c+"JetEta",                          .pfs={Stack,data,"Year",cut}, .cuts={},.draw=d,.opt=opt,.ranges=r_Stk9});
        sh.AddHistos(s+"AK4",  { .fill=c+"JetPhi",                          .pfs={Stack,data,"Year",cut}, .cuts={},.draw=d,.opt=opt,.ranges=r_Stk9});
        sh.AddHistos(s+"AK4",  { .fill=c+"JetDeepB",                        .pfs={Stack,data,"Year",cut}, .cuts={},.draw=d,.opt=opt,.ranges=r_Stk9});
        sh.AddHistos("AK4",    { .fill="JetPhotonDR",                       .pfs={Stack,data,"Year",cut}, .cuts={},.draw=d,.opt=opt,.ranges=r_Stk9});
        sh.AddHistos("AK4",    { .fill="JetPhotonPtRatio",                  .pfs={Stack,data,"Year",cut}, .cuts={},.draw=d,.opt=opt,.ranges=r_Stk9});
        sh.AddHistos("AK4",    { .fill="JetPhotonPtRatio",                  .pfs={Stack,data,"Year",cut,"JetPhotonDR0.05"}, .cuts={},.draw=d,.opt=opt,.ranges=r_Stk9});
        sh.AddHistos("AK4",    { .fill="JetPhotonPtRatio",                  .pfs={Stack,data,"Year",cut,"JetPhotonDR0.4"},  .cuts={},.draw=d,.opt=opt,.ranges=r_Stk9});
        sh.AddHistos("AK4",    { .fill="JetPhotonDR_vs_JetPhotonPtRatio",   .pfs={"Data_MC","Year",cut},  .cuts={},.draw="COLZ",.opt=o_1or2d_d, .ranges={}});
        sh.AddHistos("AK4",    { .fill="JetEleDR",                          .pfs={Stack,data,"Year",cut}, .cuts={},.draw=d,.opt=opt,.ranges=r_Stk9});
        sh.AddHistos("AK4",    { .fill="JetElePtRatio",                     .pfs={Stack,data,"Year",cut}, .cuts={},.draw=d,.opt=opt,.ranges=r_Stk9});
        sh.AddHistos("AK4",    { .fill="JetElePtRatio",                     .pfs={Stack,data,"Year",cut,"JetEleDR0.05"}, .cuts={},.draw=d,.opt=opt,.ranges=r_Stk9});
        sh.AddHistos("AK4",    { .fill="JetElePtRatio",                     .pfs={Stack,data,"Year",cut,"JetEleDR0.4"},  .cuts={},.draw=d,.opt=opt,.ranges=r_Stk9});
        sh.AddHistos("AK4",    { .fill="JetEleDR_vs_JetElePtRatio",         .pfs={"Data_MC","Year",cut},  .cuts={},.draw="COLZ",.opt=o_1or2d_d, .ranges={}});
        sh.AddHistos("AK4",    { .fill="JetMuonDR",                         .pfs={Stack,data,"Year",cut}, .cuts={},.draw=d,.opt=opt,.ranges=r_Stk9});
        sh.AddHistos("AK4",    { .fill="JetMuonPtRatio",                    .pfs={Stack,data,"Year",cut}, .cuts={},.draw=d,.opt=opt,.ranges=r_Stk9});
        sh.AddHistos("AK4",    { .fill="JetMuonPtRatio",                    .pfs={Stack,data,"Year",cut,"JetMuonDR0.05"}, .cuts={},.draw=d,.opt=opt,.ranges=r_Stk9});
        sh.AddHistos("AK4",    { .fill="JetMuonPtRatio",                    .pfs={Stack,data,"Year",cut,"JetMuonDR0.4"},  .cuts={},.draw=d,.opt=opt,.ranges=r_Stk9});
  ...
  //for (auto region : {'S', Region::CR_QCD, Region::Val_Signal, Region::Val_QCD}) {
    ...
    for (auto data : showdata)  {
      if (region==Region::Pre) {
        sh.AddHistos(s+"evt",      { .fill=c+"NEleVeto",             .pfs={Stack,data,"Year",cut},                    .cuts={},.draw=d,.opt=o_stk_d,.ranges=r_Stk6});
        sh.AddHistos(s+"ele veto", { .fill=c+"VetoElePt",            .pfs={Stack,data,"Year",cut},                    .cuts={},.draw=d,.opt=o_stk_d+"logX",.ranges=r_Stk6});
        sh.AddHistos(s+"ele veto", { .fill=c+"VetoEleEta",           .pfs={Stack,data,"Year",cut},                    .cuts={},.draw=d,.opt=o_stk_d,.ranges=r_Stk6});
        sh.AddHistos(s+"evt",      { .fill=c+"NMuVeto",              .pfs={Stack,data,"Year",cut},                    .cuts={},.draw=d,.opt=o_stk_d,.ranges=r_Stk6});
        sh.AddHistos(s+"mu veto",  { .fill=c+"VetoMuPt",             .pfs={Stack,data,"Year",cut},                    .cuts={},.draw=d,.opt=o_stk_d+"logX",.ranges=r_Stk6});
        sh.AddHistos(s+"mu veto",  { .fill=c+"VetoMuEta",            .pfs={Stack,data,"Year",cut},                    .cuts={},.draw=d,.opt=o_stk_d,.ranges=r_Stk6});
        sh.AddHistos(s+"evt",      { .fill=c+"NLepVeto",             .pfs={Stack,data,"Year",cut},                    .cuts={},.draw=d,.opt=o_stk_d,.ranges=r_Stk6});
        sh.AddHistos(s+"evt",      { .fill=c+"NIsoTrk",              .pfs={Stack,data,"Year",cut},                    .cuts={},.draw=d,.opt=o_stk_d,.ranges=r_Stk6});
        sh.AddHistos(s+"evt",      { .fill=c+"NTauVeto",             .pfs={Stack,data,"Year",cut},                    .cuts={},.draw=d,.opt=o_stk_d,.ranges=r_Stk6});
        sh.AddHistos(s+"tau veto", { .fill=c+"VetoTauPt",            .pfs={Stack,data,"Year",cut},                    .cuts={},.draw=d,.opt=o_stk_d+"logX",.ranges=r_Stk6});
        sh.AddHistos(s+"tau veto", { .fill=c+"VetoTauEta",           .pfs={Stack,data,"Year",cut},                    .cuts={},.draw=d,.opt=o_stk_d,.ranges=r_Stk6});
        ...
        sh.AddHistos(s+"evt",      { .fill=c+"NEleVeto",             .pfs={Stack,data,"Year",cut+"_Excl1LepMT"},      .cuts={},.draw=d,.opt=o_stk_d,.ranges=r_Stk6});
        sh.AddHistos(s+"ele veto", { .fill=c+"VetoElePt",            .pfs={Stack,data,"Year",cut},                    .cuts={},.draw=d,.opt=o_stk_d+"logX",.ranges=r_Stk6});
        sh.AddHistos(s+"ele veto", { .fill=c+"VetoEleEta",           .pfs={Stack,data,"Year",cut},                    .cuts={},.draw=d,.opt=o_stk_d,.ranges=r_Stk6});
        sh.AddHistos(s+"evt",      { .fill=c+"NMuVeto",              .pfs={Stack,data,"Year",cut+"_Excl1LepMT"},      .cuts={},.draw=d,.opt=o_stk_d,.ranges=r_Stk6});
        sh.AddHistos(s+"mu veto",  { .fill=c+"VetoMuPt",             .pfs={Stack,data,"Year",cut},                    .cuts={},.draw=d,.opt=o_stk_d+"logX",.ranges=r_Stk6});
        sh.AddHistos(s+"mu veto",  { .fill=c+"VetoMuEta",            .pfs={Stack,data,"Year",cut},                    .cuts={},.draw=d,.opt=o_stk_d,.ranges=r_Stk6});
        sh.AddHistos(s+"evt",      { .fill=c+"NLepVeto",             .pfs={Stack,data,"Year",cut+"_Excl1LepMT"},      .cuts={},.draw=d,.opt=o_stk_d,.ranges=r_Stk6});
      } else {
        std::string opt = (data=="Blind") ? o_stk_s : o_stk_d;
        sh.AddHistos(s+"evt",      { .fill=c+"NEleVeto",             .pfs={Stack,data,"Year",cut+"_Excl0Ele0Tau"}, .cuts={},.draw=d,.opt=opt,.ranges=r_Stk6});
        sh.AddHistos(s+"ele veto", { .fill=c+"VetoElePt",            .pfs={Stack,data,"Year",cut+"_Excl0Ele0Tau"}, .cuts={},.draw=d,.opt=o_stk_d+"logX",.ranges=r_Stk6});
        sh.AddHistos(s+"ele veto", { .fill=c+"VetoEleEta",           .pfs={Stack,data,"Year",cut+"_Excl0Ele0Tau"}, .cuts={},.draw=d,.opt=o_stk_d,.ranges=r_Stk6});
        sh.AddHistos(s+"evt",      { .fill=c+"NMuVeto",              .pfs={Stack,data,"Year",cut+"_Excl0Mu0Tau"},  .cuts={},.draw=d,.opt=opt,.ranges=r_Stk6});
        sh.AddHistos(s+"mu veto",  { .fill=c+"VetoMuPt",             .pfs={Stack,data,"Year",cut+"_Excl0Mu0Tau"},  .cuts={},.draw=d,.opt=o_stk_d+"logX",.ranges=r_Stk6});
        sh.AddHistos(s+"mu veto",  { .fill=c+"VetoMuEta",            .pfs={Stack,data,"Year",cut+"_Excl0Mu0Tau"},  .cuts={},.draw=d,.opt=o_stk_d,.ranges=r_Stk6});
        sh.AddHistos(s+"evt",      { .fill=c+"NLepVeto",             .pfs={Stack,data,"Year",cut+"_Excl0Ele0Mu0Tau"}, .cuts={},.draw=d,.opt=opt,.ranges=r_Stk6});
        sh.AddHistos(s+"evt",      { .fill=c+"NIsoTrk",              .pfs={Stack,data,"Year",cut+"_Excl0Tau"},  .cuts={},.draw=d,.opt=o_stk_d,.ranges=r_Stk6});
        sh.AddHistos(s+"evt",      { .fill=c+"NTauVeto",             .pfs={Stack,data,"Year",cut+"_Excl0Tau"},  .cuts={},.draw=d,.opt=opt,.ranges=r_Stk6});
        sh.AddHistos(s+"tau veto", { .fill=c+"VetoTauPt",            .pfs={Stack,data,"Year",cut+"_Excl0Tau"},  .cuts={},.draw=d,.opt=o_stk_d+"logX",.ranges=r_Stk6});
        sh.AddHistos(s+"tau veto", { .fill=c+"VetoTauEta",           .pfs={Stack,data,"Year",cut+"_Excl0Tau"},  .cuts={},.draw=d,.opt=o_stk_d,.ranges=r_Stk6});
      }
    }
  }
  ...
  //for (auto region : {Region::CR_2LepInv, Region::CR_Top, Region::CR_W}) {
    ...
    sh.AddHistos(s+"evt",  { .fill=c+"ElePt",                      .pfs={Stack,"JetHTMET","Year",cut},  .cuts={},.draw=d,.opt=o_stk_d,.ranges=r_Stk6});
    sh.AddHistos(s+"evt",  { .fill=c+"EleEta",                     .pfs={Stack,"JetHTMET","Year",cut},  .cuts={},.draw=d,.opt=o_stk_d,.ranges=r_Stk6});
    sh.AddHistos(s+"evt",  { .fill=c+"MuPt",                       .pfs={Stack,"JetHTMET","Year",cut},  .cuts={},.draw=d,.opt=o_stk_d,.ranges=r_Stk6});
    sh.AddHistos(s+"evt",  { .fill=c+"MuEta",                      .pfs={Stack,"JetHTMET","Year",cut},  .cuts={},.draw=d,.opt=o_stk_d,.ranges=r_Stk6});
    
    sh.AddHistos(s+"evt",  { .fill=c+"NLep",                       .pfs={Stack,"JetHTMET","Year",cut2}, .cuts={},.draw=d,.opt=o_stk_d,.ranges=r_Stk6});
    sh.AddHistos(s+"evt",  { .fill=c+"NEle",                       .pfs={Stack,"JetHTMET","Year",cut2}, .cuts={},.draw=d,.opt=o_stk_d,.ranges=r_Stk6});
    sh.AddHistos(s+"evt",  { .fill=c+"NMu",                        .pfs={Stack,"JetHTMET","Year",cut2}, .cuts={},.draw=d,.opt=o_stk_d,.ranges=r_Stk6});
    sh.AddHistos(s+"evt",  { .fill=c+"NLepTight",                  .pfs={Stack,"JetHTMET","Year",cut2}, .cuts={},.draw=d,.opt=o_stk_d,.ranges=r_Stk6});
    sh.AddHistos(s+"evt",  { .fill=c+"NLepNoIso",                  .pfs={Stack,"JetHTMET","Year",cut2}, .cuts={},.draw=d,.opt=o_stk_d,.ranges=r_Stk6});
    sh.AddHistos(s+"evt",  { .fill=c+"NEleNoIso",                  .pfs={Stack,"JetHTMET","Year",cut2}, .cuts={},.draw=d,.opt=o_stk_d,.ranges=r_Stk6});
    sh.AddHistos(s+"evt",  { .fill=c+"NMuNoIso",                   .pfs={Stack,"JetHTMET","Year",cut2}, .cuts={},.draw=d,.opt=o_stk_d,.ranges=r_Stk6});
    sh.AddHistos(s+"evt",  { .fill=c+"NLepNonIso",                 .pfs={Stack,"JetHTMET","Year",cut2}, .cuts={},.draw=d,.opt=o_stk_d,.ranges=r_Stk6});
    sh.AddHistos(s+"evt",  { .fill=c+"NEleNonIso",                 .pfs={Stack,"JetHTMET","Year",cut2}, .cuts={},.draw=d,.opt=o_stk_d,.ranges=r_Stk6});
    sh.AddHistos(s+"evt",  { .fill=c+"NMuNonIso",                  .pfs={Stack,"JetHTMET","Year",cut2}, .cuts={},.draw=d,.opt=o_stk_d,.ranges=r_Stk6});
  }
  ...
  for (auto region : {Region::Pre, Region::CR_Top17_1Boost, Region::CR_2LepInv, Region::CR_1PhoInv, Region::Val_Signal}) {
    ...
    for (auto data : showdata ) {
      std::string opt = (data=="Blind") ? o_stk_s : o_stk_d;
      sh.AddHistos(s+"b",    { .fill=c+"BJetPtBins",          .pfs={Stack,data,"Year",cut1}, .cuts={},.draw=d,.opt=opt,.ranges=r_Stk6});
      sh.AddHistos(s+"b",    { .fill=c+"BJetPt",              .pfs={Stack,data,"Year",cut1}, .cuts={},.draw=d,.opt=opt,.ranges=r_Stk6});
      sh.AddHistos(s+"b",    { .fill=c+"BJetEta",             .pfs={Stack,data,"Year",cut1}, .cuts={},.draw=d,.opt=opt,.ranges=r_Stk6});
      sh.AddHistos(s+"b",    { .fill=c+"BJetPhi",             .pfs={Stack,data,"Year",cut1}, .cuts={},.draw=d,.opt=opt,.ranges=r_Stk6});
      sh.AddHistos(s+"b",    { .fill=c+"BJetDeepB",           .pfs={Stack,data,"Year",cut1}, .cuts={},.draw=d,.opt=opt,.ranges=r_Stk6});
      sh.AddHistos(s+"evt",  { .fill=c+"NBTag",               .pfs={Stack,data,"Year",cut1}, .cuts={},.draw=d,.opt=opt,.ranges=r_Stk6});
      //if (region!=Region::Pre&&region!=Region::CR_2LepInv&&region!=Region::CR_1PhoInv)
      //	sh.AddHistos(s+"evt",  { .fill=c+"NBTag",               .pfs={Stack,data,"Year",cut2}, .cuts={},.draw=d,.opt=opt,.ranges=r_Stk6});
    }
  }
  ...
  for (auto region : {Region::Pre, Region::CR_QCD17_1Boost, Region::CR_W17_1Boost, Region::CR_1LepInv, Region::CR_2LepInv, Region::CR_1PhoInv, Region::Val_QCD}) {
    ...
    sh.AddHistos(s+"evt",  { .fill=c+"NLooseBTag",          .pfs={Stack,"JetHTMET","Year",cut1}, .cuts={},.draw=d,.opt=O_stk_d+"NoComb5",.ranges={0,0, 1.01e-2,1e6,  0.5,0.86}});
    //if (region!=Region::Pre&&region!=Region::CR_2LepInv&&region!=Region::CR_1PhoInv)
    //  sh.AddHistos(s+"evt",  { .fill=c+"NLooseBTag",          .pfs={Stack,"JetHTMET","Year",cut2}, .cuts={},.draw=d,.opt=O_stk_d+"NoComb5",.ranges={0,0, 1.01e-2,1e6,  0.5,0.86}});
  }
  ...
  for (auto region : {Region::Pre, Region::CR_Top17_1Boost,Region::CR_W17_1Boost,Region::CR_QCD17_1Boost, Region::CR_1LepInv, Region::CR_2LepInv, Region::CR_1PhoInv, Region::CR_Fake, Region::Val_Signal, Region::Val_QCD}) {
	...
	std::string Opt = (data=="Blind") ? O_stk_s : O_stk_d;
	// AK8 jets
	sh.AddHistos(s+"evt",  { .fill=c+"NJetAK8",            .pfs={Stack,data,"Year",cut},               .cuts={},.draw=d,.opt=opt,.ranges=r_Stk6});
	sh.AddHistos(s+"AK8",  { .fill=c+"JetAK8PtBins",       .pfs={Stack,data,"Year",cut},               .cuts={},.draw=d,.opt=opt,.ranges=r_Stk8});
	sh.AddHistos(s+"AK8",  { .fill=c+"JetAK8Pt",           .pfs={Stack,data,"Year",cut},               .cuts={},.draw=d,.opt=opt,.ranges=r_Stk8});
	sh.AddHistos(s+"AK8",  { .fill=c+"JetAK8Eta",          .pfs={Stack,data,"Year",cut},               .cuts={},.draw=d,.opt=opt,.ranges=r_Stk8});
	sh.AddHistos(s+"AK8",  { .fill=c+"JetAK8Phi",          .pfs={Stack,data,"Year",cut},               .cuts={},.draw=d,.opt=opt,.ranges=r_Stk8});
	sh.AddHistos(s+"AK8",  { .fill=c+"JetAK8Mass",         .pfs={Stack,data,"Year",cut},               .cuts={},.draw=d,.opt=opt,.ranges=r_Stk8});
	sh.AddHistos(s+"AK8",  { .fill=c+"JetAK8Mass",         .pfs={Stack,data,"Year",cut,"Tau21Tagged"}, .cuts={},.draw=d,.opt=Opt,.ranges={0,0, 1.01e-2,1e8,  0.3,0.86, 0.21}});
	sh.AddHistos(s+"AK8",  { .fill=c+"JetAK8Mass",         .pfs={Stack,data,"Year",cut,"Tau32Tagged"}, .cuts={},.draw=d,.opt=Opt,.ranges={0,0, 1.01e-2,1e8,  0.3,0.86}});
	sh.AddHistos(s+"AK8",  { .fill=c+"JetAK8Mass",         .pfs={Stack,data,"Year",cut,"AK8_EB_EE"},               .cuts={},.draw=d,.opt=opt,.ranges=r_Stk8});
	//sh.AddHistos(s+"AK8",  { .fill=c+"JetAK8Mass",         .pfs={Stack,data,"Year",cut,"AK8_EB_EE","Tau21Tagged"}, .cuts={},.draw=d,.opt=opt,.ranges=r_Stk8});
	//sh.AddHistos(s+"AK8",  { .fill=c+"JetAK8Mass",         .pfs={Stack,data,"Year",cut,"AK8_EB_EE","Tau32Tagged"}, .cuts={},.draw=d,.opt=opt,.ranges=r_Stk8});
	sh.AddHistos(s+"AK8",  { .fill=c+"JetAK8Tau21",        .pfs={Stack,data,"Year",cut},               .cuts={},.draw=d,.opt=opt,.ranges=r_Stk8});
	sh.AddHistos(s+"AK8",  { .fill=c+"JetAK8Tau32",        .pfs={Stack,data,"Year",cut},               .cuts={},.draw=d,.opt=opt,.ranges=r_Stk8});
	sh.AddHistos(s+"AK8",  { .fill=c+"MaxAK8SubJetDeepB",  .pfs={Stack,data,"Year",cut},               .cuts={},.draw=d,.opt=opt,.ranges=r_Stk8});
	sh.AddHistos("AK8",    { .fill="JetAK8PhotonDR",       .pfs={Stack,data,"Year",cut},               .cuts={},.draw=d,.opt=opt,.ranges=r_Stk6});
	sh.AddHistos("AK8",    { .fill="JetAK8PhotonPtRatio",  .pfs={Stack,data,"Year",cut},               .cuts={},.draw=d,.opt=opt,.ranges=r_Stk6});
	sh.AddHistos("AK8",    { .fill="JetAK8PhotonPtRatio",  .pfs={Stack,data,"Year",cut,"JetAK8PhotonDR0.05"}, .cuts={},.draw=d,.opt=opt,.ranges=r_Stk6});
	sh.AddHistos("AK8",    { .fill="JetAK8PhotonPtRatio",  .pfs={Stack,data,"Year",cut,"JetAK8PhotonDR0.8"}, .cuts={},.draw=d,.opt=opt,.ranges=r_Stk6});
	sh.AddHistos("AK8",    { .fill="JetAK8PhotonDR_vs_JetAK8PhotonPtRatio", .pfs={"Data_MC","Year",cut},  .cuts={},.draw="COLZ",.opt=o_1or2d_d, .ranges={}});
	sh.AddHistos("AK8",    { .fill="JetAK8EleDR",          .pfs={Stack,data,"Year",cut},               .cuts={},.draw=d,.opt=opt,.ranges=r_Stk6});
	sh.AddHistos("AK8",    { .fill="JetAK8ElePtRatio",     .pfs={Stack,data,"Year",cut},               .cuts={},.draw=d,.opt=opt,.ranges=r_Stk6});
	sh.AddHistos("AK8",    { .fill="JetAK8ElePtRatio",     .pfs={Stack,data,"Year",cut,"JetAK8EleDR0.05"}, .cuts={},.draw=d,.opt=opt,.ranges=r_Stk6});
	sh.AddHistos("AK8",    { .fill="JetAK8ElePtRatio",     .pfs={Stack,data,"Year",cut,"JetAK8EleDR0.8"}, .cuts={},.draw=d,.opt=opt,.ranges=r_Stk6});
	sh.AddHistos("AK8",    { .fill="JetAK8EleDR_vs_JetAK8ElePtRatio", .pfs={"Data_MC","Year",cut},  .cuts={},.draw="COLZ",.opt=o_1or2d_d, .ranges={}});
	sh.AddHistos("AK8",    { .fill="JetAK8MuonDR",         .pfs={Stack,data,"Year",cut},               .cuts={},.draw=d,.opt=opt,.ranges=r_Stk6});
	sh.AddHistos("AK8",    { .fill="JetAK8MuonPtRatio",    .pfs={Stack,data,"Year",cut},               .cuts={},.draw=d,.opt=opt,.ranges=r_Stk6});
	sh.AddHistos("AK8",    { .fill="JetAK8MuonPtRatio",    .pfs={Stack,data,"Year",cut,"JetAK8MuonDR0.05"}, .cuts={},.draw=d,.opt=opt,.ranges=r_Stk6});
	sh.AddHistos("AK8",    { .fill="JetAK8MuonPtRatio",    .pfs={Stack,data,"Year",cut,"JetAK8MuonDR0.8"}, .cuts={},.draw=d,.opt=opt,.ranges=r_Stk6});
	...
	sh.AddHistos(s+"AK8",  { .fill=c+"JetAK8DeepTagTvsQCD",    .pfs={Stack,data,"Year",cut},               .cuts={},.draw=d,.opt=opt,.ranges=r_Stk8});
	sh.AddHistos(s+"AK8",  { .fill=c+"JetAK8DeepTagWvsQCD",    .pfs={Stack,data,"Year",cut},               .cuts={},.draw=d,.opt=opt,.ranges=r_Stk8});
	sh.AddHistos(s+"AK8",  { .fill=c+"JetAK8DeepTagZvsQCD",    .pfs={Stack,data,"Year",cut},               .cuts={},.draw=d,.opt=opt,.ranges=r_Stk8});
	sh.AddHistos(s+"AK8",  { .fill=c+"JetAK8DeepTagMDHbbvsQCD",.pfs={Stack,data,"Year",cut},               .cuts={},.draw=d,.opt=opt,.ranges=r_Stk8});
	sh.AddHistos(s+"AK8",  { .fill=c+"JetAK8DeepTagMDWvsQCD",  .pfs={Stack,data,"Year",cut},               .cuts={},.draw=d,.opt=opt,.ranges=r_Stk8});
	sh.AddHistos(s+"AK8",  { .fill=c+"JetAK8DeepTagMDTvsQCD",  .pfs={Stack,data,"Year",cut},               .cuts={},.draw=d,.opt=opt,.ranges=r_Stk8});

	// Tagged Ws
	// Add W scale factor
	sh.AddHistos(s+"hadw",    { .fill=c+"WPtBins",            .pfs={Stack,data,"Year",cut},               .cuts={},.draw=d,.opt=opt,.ranges=r_Stk4});
	sh.AddHistos(s+"hadw",    { .fill=c+"WPt",                .pfs={Stack,data,"Year",cut},               .cuts={},.draw=d,.opt=opt,.ranges=r_Stk4});
	sh.AddHistos(s+"hadw",    { .fill=c+"WEta",               .pfs={Stack,data,"Year",cut},               .cuts={},.draw=d,.opt=opt,.ranges=r_Stk4});
	sh.AddHistos(s+"hadw",    { .fill=c+"WPhi",               .pfs={Stack,data,"Year",cut},               .cuts={},.draw=d,.opt=opt,.ranges=r_Stk4});
	sh.AddHistos(s+"hadw",    { .fill=c+"WTau21",             .pfs={Stack,data,"Year",cut},               .cuts={},.draw=d,.opt=Opt,.ranges=r_Stk4});
	sh.AddHistos(s+"hadw",    { .fill=c+"WMass",              .pfs={Stack,data,"Year",cut},               .cuts={},.draw=d,.opt=opt,.ranges=r_Stk4});
        
	// Tagged tops
	// Add top scale factor
	sh.AddHistos(s+"hadtop",  { .fill=c+"TopPtBins",          .pfs={Stack,data,"Year",cut},               .cuts={},.draw=d,.opt=opt,.ranges=r_Stk4});
	sh.AddHistos(s+"hadtop",  { .fill=c+"TopPt",              .pfs={Stack,data,"Year",cut},               .cuts={},.draw=d,.opt=opt,.ranges=r_Stk4});
	sh.AddHistos(s+"hadtop",  { .fill=c+"TopEta",             .pfs={Stack,data,"Year",cut},               .cuts={},.draw=d,.opt=opt,.ranges=r_Stk4});
	sh.AddHistos(s+"hadtop",  { .fill=c+"TopPhi",             .pfs={Stack,data,"Year",cut},               .cuts={},.draw=d,.opt=opt,.ranges=r_Stk4});
	sh.AddHistos(s+"hadtop",  { .fill=c+"TopTau32",           .pfs={Stack,data,"Year",cut},               .cuts={},.draw=d,.opt=opt,.ranges=r_Stk4});
	sh.AddHistos(s+"hadtop",  { .fill=c+"TopMass",            .pfs={Stack,data,"Year",cut},               .cuts={},.draw=d,.opt=opt,.ranges=r_Stk4});
      }
    }
  }
