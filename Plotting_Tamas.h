...
//       sh.AddHistos("gen leptop vs reco ele eta", { .fill="GenLepEta_vs_EleEta",   .pfs={"Signals_Background","Year",cut2,"GenTopLeptonFlavour"}, .cuts={},.draw="COLZ",.opt=o_1or2d_s+"Log",.ranges={}}); //TODO
      sh.AddHistos("gen leptop eta", { .fill="GenLepEta",   .pfs={"Signals_Background","Year",cut2,"GenTopLeptonFlavour"}, .cuts={},.draw="HIST",.opt=o_1or2d_s+"Log",.ranges={}}); //TODO
    }
  }
